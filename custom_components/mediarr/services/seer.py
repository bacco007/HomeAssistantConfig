                ...
                async with self._session.get(
                    ...
                    if response.status == 200:
                        ...
                        for request in requests['results'][:self._max_items]:
                            ...
                            request_id = request.get('id')  # Get the request ID
                            ...
                            request_data = {
                                ...
                                'flag': 1,
                                'request_id': request_id,  # Add the request ID to the data
                                'media_type': media_type,  # Add the media type
                                'tmdb_id': tmdb_id  # Add the TMDB ID
                            }
