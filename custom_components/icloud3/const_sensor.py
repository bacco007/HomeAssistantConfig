...
from .const     import (DISTANCE_TO_DEVICES,
                        ...
                        BADGE,
                        TRIGGER,
                        FROM_ZONE, ZONE_INFO, NEARBY_DEVICE_USED,
...
SENSOR_DEFINITION = {
        ...
        BATTERY: [
                ...
                [BATTERY_STATUS, BATTERY_SOURCE, BATTERY_UPDATE_TIME,
                        'iosapp_sensor-battery_level', 'iosapp_sensor-battery_status'],
                0],
        BATTERY_STATUS: [
                'BatteryStatus',
                'text, title',
        ...
        TRAVEL_TIME: [
                ...
                [FROM_ZONE, TRAVEL_TIME, TRAVEL_TIME_MIN, TRAVEL_TIME_HHMM,
                        ARRIVAL_TIME, NEARBY_DEVICE_USED],
                0],
        TRAVEL_TIME_MIN: [
                'TravelTime (min)',
                'timer',
        ...
        ZONE_DISTANCE: [
                ...
                [FROM_ZONE, ZONE_DISTANCE_M, ZONE_DISTANCE_M_EDGE,
                        MAX_DISTANCE, CALC_DISTANCE, WAZE_DISTANCE, WAZE_METHOD, NEARBY_DEVICE_USED],
                0],
        DISTANCE: [
                'Distance',
                'distance, km-mi',
