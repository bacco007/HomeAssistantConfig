...
class NSWHSensor(Entity):
    ...
    def update(self):
        ...
        url = "https://data.nsw.gov.au/data/dataset/5424aa3b-550d-4637-ae50-7f458ce327f4/resource/cfff5b74-6e2b-4883-bc44-311a214459d5/download/covid-19-tests-by-date-and-location-and-result.csv"
        ...
        self._attributes["hneh_dates"] = "1st: " + str(df_hneh_earliest) + " - Last: " + str(df_hneh_latest)
        self._attributes["trc"] = df_trc_count
        self._attributes["trc_dates"] = "1st: " + str(df_trc_earliest) + " - Last: " + str(df_trc_latest)
        self._attributes["tamw"] = df_tamw_count
        self._attributes["tamw_dates"] = "1st: " + str(df_tamw_earliest) + " - Last: " + str(df_tamw_latest)
