...
<details><summary>616 Integrations</summary>
...
| [Composite Device Tracker](https://github.com/pnbruckner/ha-composite-tracker) |  [v3.4.3] | Home Assistant Composite Device Tracker |[@pnbruckner](https://github.com/pnbruckner).|
...
| [Dyson](https://github.com/libdyson-wg/ha-dyson) |  [v1.4.0] | Home Assistant custom integration for Wi-Fi connected Dyson devices |[@libdyson-wg](https://github.com/libdyson-wg), [@dotvezz](https://github.com/dotvezz).|
...
| [Llm Vision](https://github.com/valentinfrlch/ha-llmvision) |  [v1.0.3] | Image Analyzer for Home Assistant using Multimodal LLMs |[@valentinfrlch](https://github.com/valentinfrlch).|
...
| [Multiscrape](https://github.com/danieldotnl/ha-multiscrape) |  [v7.0.3] | Home Assistant custom component for scraping (html, xml or json) multiple values (from a single HTTP request) with a separate sensor/attribute for each value. Support for (login) form-submit functionality. |[@danieldotnl](https://github.com/danieldotnl).|
| [Music Assistant](https://github.com/music-assistant/hass-music-assistant) |  [v2024.8.0] | Turn your Home Assistant instance into a jukebox, hassle free streaming of your favorite media to Home Assistant media players. |[@music-assistant](https://github.com/music-assistant).|
...
| [Passive Ble Monitor Integration](https://github.com/custom-components/ble_monitor) |  [v12.14.0] | BLE monitor for passive BLE sensors |[@Ernst79](https://github.com/Ernst79), [@myhomeiot](https://github.com/myhomeiot).|
| [Pirate Weather](https://github.com/Pirate-Weather/pirate-weather-ha) |  [v1.5.7] | Replacement for the default Dark Sky Home Assistant integration using Pirate Weather |[@alexander0042](https://github.com/alexander0042).|
...
| [Powercalc](https://github.com/bramstroker/homeassistant-powercalc) |  [v1.14.2] | Custom component to calculate estimated power consumption of lights and other appliances |[@bramstroker](https://github.com/bramstroker).|
...
| [Spotifyplus](https://github.com/thlucas1/homeassistantcomponent_spotifyplus) |  [v1.0.50] | Home Assistant integration for Spotify Player control, services, and soundtouchplus integration support. |[@thlucas1](https://github.com/thlucas1).|
...
| [Bubble Card](https://github.com/Clooos/Bubble-Card) |  [v2.2.2] | Bubble Card is a minimalist card collection for Home Assistant with a nice pop-up touch. |
...
| [Clock Weather Card](https://github.com/pkissling/clock-weather-card) |  [v2.8.3] | A Home Assistant Card indicating today's date/time, along with an iOS inspired weather forecast for the next days with animated icons |
...
| [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) |  [v6.1.0] | 🙈 Hides the Home Assistant header and/or sidebar |
...
| [Mushroom](https://github.com/piitaya/lovelace-mushroom) |  [v4.0.3] | Build a beautiful Home Assistant dashboard easily |
...
| Browserless Chromium | 2.16.1 |  | db21ed7f |
| Cloudflared | 5.1.17 |  | 9074a9fa |
| DbStats | 0.5.8 |  | 8bce8ef4 |
| ESPHome | 2024.7.3 |  | 15ef4d2f |
| eufy-security-ws | 1.8.0-2 |  | 402f1039 |
| Get HACS | 1.2.1 |  | cb646a50 |
...
| Music Assistant Server | 2.1.4 |  | d5369777 |
...
[ha-version-shield]: https://img.shields.io/badge/2024.8.2-555555?style=flat-square&logo=home-assistant
