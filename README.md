...
| [Lunar Phase](https://github.com/ngocjohn/lunar-phase) |  [v0.2.1] | 🌘  Lunar Phase Integration for Home Assistant |[@ngocjohn](https://github.com/ngocjohn).|
| [Material Symbols](https://github.com/beecho01/material-symbols) |  [v2024.11.23] | Material Symbols for Home Assistant is a collection of 13,693 Google Material Symbols for use within Home Assistant. It uses the icon-set produced and maintained by iconify. |[@beecho01](https://github.com/beecho01).|
...
| [Solcast Pv Forecast](https://github.com/BJReplay/ha-solcast-solar) |  [v4.2.6] | Solcast Integration for Home Assistant |[@BJReplay](https://github.com/BJReplay), [@autoSteve](https://github.com/autoSteve).|
...
| [Spotifyplus](https://github.com/thlucas1/homeassistantcomponent_spotifyplus) |  [v1.0.66] | Home Assistant integration for Spotify Player control, services, and soundtouchplus integration support. |[@thlucas1](https://github.com/thlucas1).|
...
| [Mushroom](https://github.com/piitaya/lovelace-mushroom) |  [v4.2.0] | Build a beautiful Home Assistant dashboard easily |
...
| [Sonos Card](https://github.com/punxaphil/custom-sonos-card) |  [v8.2.0] | Home Assistant custom lovelace sonos card |
...
| ESPHome Device Compiler | 2024.11.2 |  | 15ef4d2f |
...
[ha-version-shield]: https://img.shields.io/badge/2024.12.0b4-555555?style=flat-square&logo=home-assistant
