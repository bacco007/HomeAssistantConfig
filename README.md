...
<details><summary>611 Integrations</summary>
...
| [Dynamic Energy Cost](https://github.com/martinarva/dynamic_energy_cost) |  [v0.4.2] |  |[@martinarva](https://github.com/martinarva).|
...
| [Spotifyplus](https://github.com/thlucas1/homeassistantcomponent_spotifyplus) |  [v1.0.38] | Home Assistant integration for Spotify Player control, services, and soundtouchplus integration support. |[@thlucas1](https://github.com/thlucas1).|
...
| [Watchman](https://github.com/dummylabs/thewatchman) |  [v0.6.2] | Home Assistant custom integration to keep track of missing entities and services in your config files |[@dummylabs](https://github.com/dummylabs).|
...
| [Bubble Card](https://github.com/Clooos/Bubble-Card) |  [v2.0.4] | Bubble Card is a minimalist card collection for Home Assistant with a nice pop-up touch. |
...
| [Clock Weather Card](https://github.com/pkissling/clock-weather-card) |  [v2.8.0] | A Home Assistant Card indicating today's date/time, along with an iOS inspired weather forecast for the next days with animated icons |
...
| [Custom Brand Icons](https://github.com/elax46/custom-brand-icons) |  [v2024.6.1] | Custom brand icons for Home Assistant |
...
| [Firemote Card](https://github.com/PRProd/HA-Firemote) |  [v3.4.9] | Apple TV, Amazon Fire TV, Fire streaming stick, Chromecast, NVIDIA Shield, onn., Roku, Xiaomi Mi, and Android TV remote control card for Home Assistant |
...
| [Team Tracker Card](https://github.com/vasqued2/ha-teamtracker-card) |  [v0.13.1] | A Home Assistant frontend custom card that will display real-time updates for teams tracked with the ha-teamtracker integration.  Has custom in-game layouts for football, baseball, basketball, hockey, soccer, golf, tennis, racing, and mma. |
...
| [Week Planner Card](https://github.com/FamousWolf/week-planner-card) |  [v1.5.0] | Custom Home Assistant card displaying a responsive overview or multiple days with events from one of multiple calendars |
...
| Node-RED | 18.0.1 |  | a0d7b954 |
| OpenThread Border Router | 2.8.0 |  | core |
...
[ha-version-shield]: https://img.shields.io/badge/2024.7.0b3-555555?style=flat-square&logo=home-assistant
