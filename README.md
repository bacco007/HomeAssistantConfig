...
<details><summary>599 Integrations</summary>
...
| [Adsb.Lol For Homeassistant](https://github.com/vingerha/ha_adsb_lol) |  [v0.1.0] | Home Assistant Integration with adsb.lol |[@vingerha](https://github.com/vingerha).|
...
| [Apparent Temperature](https://github.com/Limych/ha-apparent-temperature) |  [v0.4.0] | Sensor of Apparent Temperature for Home Assistant. |[@Limych](https://github.com/Limych).|
| [Astroweather](https://github.com/mawinkler/astroweather) |  [v0.50.1] | Asynchronous Astro Weather Forecast for Home Assistant |[@mawinkler](https://github.com/mawinkler).|
...
| [Default Config Disabler](https://github.com/tronikos/default_config_disabler) |  [v0.0.3] | Disables components from Home Assistant's default_config |[@tronikos](https://github.com/tronikos).|
...
| [Flightradar24](https://github.com/AlexandrErohin/home-assistant-flightradar24) |  [v1.14.0] | Flightradar24 integration for Home Assistant |[@AlexandrErohin](https://github.com/AlexandrErohin).|
...
| [Gtfs2 For Homeassistant](https://github.com/vingerha/gtfs2) |  [v0.4.6.3] | Support GTFS in Home Assistant GUI-only |[@vingerha](https://github.com/vingerha).|
...
| [Icloud3 V3 Idevice Tracker](https://github.com/gcobb321/icloud3) |  [v3.0.5.1] | iCloud3 v3 - iCloud3 is an advanced iDevice tracker that uses Apple iCloud account and HA Companion App data for presence detection and location based automations. |[@gcobb321](https://github.com/gcobb321).|
| [Icloud3 V3, Development Version](https://github.com/gcobb321/icloud3_v3) |  [v3.0.5.1] | iCloud3 v3, Development Version - This Repo/Version is used for development and testing of new and updated features. It is not the official release of iCloud3 v3, . |[@gcobb321](https://github.com/gcobb321).|
...
| [Open Meteo Solar Forecast](https://github.com/rany2/ha-open-meteo-solar-forecast) |  | Home Assistant Open-Meteo Solar Forecast Integration |[@rany2](https://github.com/rany2).|
...
| [Smartthinq Lge Sensors](https://github.com/ollo69/ha-smartthinq-sensors) |  [v0.39.1] | HomeAssistant custom integration for SmartThinQ LG devices configurable with Lovelace User Interface. |[@ollo69](https://github.com/ollo69).|
| [Solcast Pv Solar](https://github.com/BJReplay/ha-solcast-solar) |  [v4.0.25] | Solcast Integration for Home Assistant |[@BJReplay](https://github.com/BJReplay).|
| [Solcast Pv Solar](https://github.com/oziee/ha-solcast-solar) |  [v4.0.22] | Solcast Integration for Home Assistant |[@oziee](https://github.com/oziee).|
...
| [Sun2](https://github.com/pnbruckner/ha-sun2) |  [v3.3.1] | Home Assistant Sun2 Sensor |[@pnbruckner](https://github.com/pnbruckner).|
...
| [Bubble Card](https://github.com/Clooos/Bubble-Card) |  [v2.0.0-rc.1] | Bubble Card is a minimalist card collection for Home Assistant with a nice pop-up touch. |
...
| [Clock Weather Card](https://github.com/pkissling/clock-weather-card) |  [v2.7.0] | A Home Assistant Card indicating today's date/time, along with an iOS inspired weather forecast for the next days with animated icons |
...
| [Firemote Card](https://github.com/PRProd/HA-Firemote) |  [v3.4.6] | Apple TV, Amazon Fire TV, Fire streaming stick, Chromecast, NVIDIA Shield, onn., Roku, Xiaomi Mi, and Android TV remote control card for Home Assistant |
...
| [Service Call Tile Feature For Home Assistant Tile Card](https://github.com/Nerwyn/service-call-tile-feature) |  [v3.3.7] | Home Assistant tile card custom service call (and other actions) features - buttons, sliders, selectors, and spinboxes |
...
| [Team Tracker Card](https://github.com/vasqued2/ha-teamtracker-card) |  [v0.13.0] | A Home Assistant frontend custom card that will display real-time updates for teams tracked with the ha-teamtracker integration.  Has custom in-game layouts for football, baseball, basketball, hockey, soccer, golf, tennis, racing, and mma. |
...
| [Week Planner Card](https://github.com/FamousWolf/week-planner-card) |  [v1.4.0] | Custom Home Assistant card displaying a responsive overview or multiple days with events from one of multiple calendars |
...
| Browserless Chromium | 2.12.0-3 |  | db21ed7f |
| Cloudflared | 5.1.10 |  | 9074a9fa |
| DbStats | 0.5.6 |  | 8bce8ef4 |
| ESPHome | 2024.5.4 |  | 15ef4d2f |
...
[ha-version-shield]: https://img.shields.io/badge/2024.6.0b5-555555?style=flat-square&logo=home-assistant
