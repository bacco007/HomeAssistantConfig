...
| [spotify.sensor](https://www.home-assistant.io/components/spotify.sensor) |
...
| [Fuel Prices](https://github.com/pantherale0/ha-fuelprices) |  [v2024.10.0] | A generic and extensible integration with pyfuelprices to retrieve local (or remote) fuel price data. |[@pantherale0](https://github.com/pantherale0).|
...
| [Icloud3 V3 Idevice Tracker](https://github.com/gcobb321/icloud3) |  [v3.1.1] | iCloud3 v3 - iCloud3 is an advanced iDevice tracker that uses Apple iCloud account and HA Companion App data for presence detection and location based automations. |[@gcobb321](https://github.com/gcobb321).|
...
| [Llm Vision](https://github.com/valentinfrlch/ha-llmvision) |  [v1.3] | Let Home Assistant see! |[@valentinfrlch](https://github.com/valentinfrlch).|
...
| [Music Assistant](https://github.com/music-assistant/hass-music-assistant) |  [v2024.11.1] | Turn your Home Assistant instance into a jukebox, hassle free streaming of your favorite media to Home Assistant media players. |[@music-assistant](https://github.com/music-assistant).|
...
| [Powercalc](https://github.com/bramstroker/homeassistant-powercalc) |  [v1.15.2] | Custom component to calculate estimated power consumption of lights and other appliances |[@bramstroker](https://github.com/bramstroker).|
...
| [Spotifyplus](https://github.com/thlucas1/homeassistantcomponent_spotifyplus) |  [v1.0.63] | Home Assistant integration for Spotify Player control, services, and soundtouchplus integration support. |[@thlucas1](https://github.com/thlucas1).|
...
| [Clock Weather Card](https://github.com/pkissling/clock-weather-card) |  [v2.8.5] | A Home Assistant Card indicating today's date/time, along with an iOS inspired weather forecast for the next days with animated icons |
...
| [Custom Features For Home Assistant Cards](https://github.com/Nerwyn/service-call-tile-feature) |  [v4.1.0] | Home Assistant custom features for tile cards and more. Call any action using buttons, sliders, selectors, and spinboxes |
...
| [Expander Card](https://github.com/MelleD/lovelace-expander-card) |  [v2.2.6] | Expander card for HomeAssistant |
| [Firemote Card](https://github.com/PRProd/HA-Firemote) |  [v4.1.2] | Apple TV, Amazon Fire TV, Chromecast, Homatics, NVIDIA Shield, onn., Roku, Xiaomi Mi, and Android TV remote control card for Home Assistant |
...
| [Mushroom](https://github.com/piitaya/lovelace-mushroom) |  [v4.0.8] | Build a beautiful Home Assistant dashboard easily |
...
| [Sankey Chart Card](https://github.com/MindFreeze/ha-sankey-chart) |  [v3.5.0] | A Home Assistant lovelace card to display a sankey chart. For example for power consumption |
...
| [Sonos Card](https://github.com/punxaphil/custom-sonos-card) |  [v7.21.5] | Home Assistant custom lovelace sonos card |
...
| [Streamline Card](https://github.com/brunosabot/streamline-card) |  [v0.0.14] | Streamline your Lovelace configuration with with a card template system. |
...
| [Universal Remote Card](https://github.com/Nerwyn/android-tv-card) |  [v4.1.3] | A completely customizable universal remote card for Home Assistant. Supports multiple platforms out of the box. |
...
| [Week Planner Card](https://github.com/FamousWolf/week-planner-card) |  [v1.8.0] | Custom Home Assistant card displaying a responsive overview or multiple days with events from one of multiple calendars |
