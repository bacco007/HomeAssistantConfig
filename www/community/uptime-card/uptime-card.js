...
`;console.info("%c Uptime card version 0.0.1 ","color: orange; font-weight: bold; background: black"),window.customCards=window.customCards||[],window.customCards.push({type:"uptime-card",name:"Uptime Card",description:"The uptime card show you the history of your binary sensors in a cool way."});let Et=class extends Ne{constructor(){super(...arguments),this.initialized=!1}static async getConfigElement(){return document.createElement("uptime-card-editor")}static getStubConfig(){return{}}set hass(e){this._hass=e,this.sensor=e.states[this.config.entity],this.initialized=!0,this.updateData()}setConfig(e){if(!e)throw new Error("Invalid configuration !");this.config=Object.assign(Object.assign(Object.assign({},Ce),e),{color:Object.assign(Object.assign({},Ie),e.color),alias:Object.assign({},e.alias),show:Object.assign(Object.assign({},ke),e.show),bar:Object.assign(Object.assign({},Ee),e.bar),tap_action:{action:"more-info"}}),this.initialized&&this.updateData()}shouldUpdate(e){return!!this.config&&function(e,t,n){if(t.has("config")||n)return!0;if(e.config.entity){var r=t.get("hass");return!r||r.states[e.config.entity]!==e.hass.states[e.config.entity]}return!1}(this,e,!1)}firstUpdated(e){this.updateData()}connectedCallback(){super.connectedCallback(),this.config.update_interval&&(this.interval=setInterval(()=>this.updateData(),1e3*this.config.update_interval))}disconnectedCallback(){this.interval&&clearInterval(this.interval),super.disconnectedCallback()}async updateData(){const{entity:e,hours_to_show:t}=this.config;if(this.sensor=this._hass.states[this.config.entity],null==this.sensor)return void(this.cache={points:[],lastFetched:-1,lastChanged:-1,hoursToShow:t});const n=await this.getCache(e),r=(new Date).getTime();let o;if(null==n){const e=new Date(this.sensor.last_changed).getTime();o={points:[{x:e,y:this.sensor.state}],lastFetched:r,lastChanged:e,hoursToShow:t}}else{const i=n.hoursToShow<t,s=i?this.getMinimumDate():n.lastFetched,a=await this.fetchRecent(e,new Date(s),new Date),c=i?a:[...n.points,...a],l=c.findIndex(e=>e.x>this.getMinimumDate()),u=0==l?c:c.slice(l-1),d=this.cleanPoints(u);if(d.length>0)o={points:d,lastFetched:r,lastChanged:d[d.length-1].x,hoursToShow:t};else{const e=new Date(this.sensor.last_changed).getTime();o={points:[{x:e,y:this.sensor.state}],lastFetched:r,lastChanged:e,hoursToShow:t}}}await this.setCache(e,o),this.cache=o}async getCache(e){const t=await It.getItem(e);return null==t?(console.warn(`Can't load the key ${e} from cache.`),null):(n=t,JSON.parse(n));var n}async setCache(e,t){return It.setItem(e,(n=t,JSON.stringify(n)));var n}isOk(e){const{ok:t,ko:n}=this.config;if(null!=e){if(t==e)return!0;if(n==e)return!1;if(null!=t||null!=n)return null==t||null!=n&&void 0}}findBarPeriod(e){const{bar:t}=this.config,n=this.getUptimeSize()/t.amount,r=(new Date).getTime()-(t.amount-1-e)*n;return{from:r-n+1,to:r}}findBarRepartition(e){const t=this.cache.points.findIndex(t=>t.x>=e.from),n=this.cache.points.findIndex(t=>t.x>e.to),r={ok:0,ko:0,none:100};let o;if(0==this.cache.points.length)return r;if(-1==t)o=[this.cache.points[this.cache.points.length-1]];else{if(0==t&&0==n)return r;{const e=0==t?0:1,r=-1==n?this.cache.points.length:n;o=this.cache.points.slice(t-e,r)}}const i={ok:0,ko:0,none:0},s=e.to-e.from;for(let t=0;t<o.length;t++){const n=(o[t+1]?o[t+1].x:e.to)-Math.max(o[t].x,e.from);1==this.isOk(o[t].y)?i.ok+=n:0==this.isOk(o[t].y)?i.ko+=n:i.none+=n}const a=i.ok/s*100,c=i.ko/s*100;return{ok:a,ko:c,none:100-(a+c)}}getUptimeSize(){const{hours_to_show:e}=this.config;return 36e5*e}getMinimumDate(){return(new Date).getTime()-this.getUptimeSize()}getColor(e){const{color:t}=this.config;return 1==this.isOk(e)?t.ok:0==this.isOk(e)?t.ko:t.none}getCssColor(e,t){var n;const r=1==e?this.getColor(null===(n=this.sensor)||void 0===n?void 0:n.state):t||void 0;return r?`color: ${r};`:""}async fetchRecent(e,t,n){let r="history/period";t&&(r+="/"+t.toISOString()),r+="?filter_entity_id="+e,n&&(r+="&end_time="+n.toISOString()),r+="&minimal_response";return(await this._hass.callApi("GET",r))[0].map(e=>({x:new Date(e.last_changed).getTime(),y:e.state}))}cleanPoints(e){const t=[];let n=void 0;for(const r of e)r.y!=n&&(t.push(r),n=r.y);return t}render(){const{bar:e}=this.config,t=[...Array(e.amount).keys()].map((e,t)=>{const n=this.findBarPeriod(t);return this.findBarRepartition(n)});return oe`
    ...
    ></rect>`}renderFooter(e){const{show:t}=this.config;return t.footer?oe`
            ...
            <div class="line"></div>
        `}static get styles(){return kt}};e([ye({attribute:!1})],Et.prototype,"_hass",void 0),e([be()],Et.prototype,"config",void 0),e([be()],Et.prototype,"sensor",void 0),e([be()],Et.prototype,"interval",void 0),e([be()],Et.prototype,"cache",void 0),e([be()],Et.prototype,"initialized",void 0),Et=e([ge("uptime-card")],Et);export{Et as UptimeCard};
