 ...
 */const ze=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,ke=1073741823;const Ne=ye(class extends Ve{constructor(){super(...arguments),this._$Cwt=ke,this._$Cbt=[],this._$CK=new Me(this),this._$CX=new He}render(...e){return e.find((e=>!ze(e)))??G}update(e,t){const A=this._$Cbt;let i=A.length;this._$Cbt=t;const s=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){const r=t[e];if(!ze(r))return this._$Cwt=e,r;e<i&&r===A[e]||(this._$Cwt=ke,i=0,Promise.resolve(r).then((async e=>{for(;o.get();)await o.get();const t=s.deref();if(void 0!==t){const A=t._$Cbt.indexOf(r);A>-1&&A<t._$Cwt&&(t._$Cwt=A,t.setValue(e))}})))}return G}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),{SHUFFLE_SET:xe,REPEAT_SET:Te,PLAY:Xe,PAUSE:Ue,NEXT_TRACK:je,PREVIOUS_TRACK:Re}=Ee;class Ge extends oe{constructor(){super(...arguments),this.volDown=async()=>await this.mediaControlService.volumeDown(this.activePlayer),this.volUp=async()=>await this.mediaControlService.volumeUp(this.activePlayer)}render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaControlService=this.store.mediaControlService;const e=!!this.config.showVolumeUpAndDownButtons&&W;return R`
    ...
    `}}e([le({attribute:!1})],Ge.prototype,"store",void 0),customElements.define("sonos-player-controls",Ge);const We="sonos-card-dispatch-event-",De="active-player",Ze=We+De,qe=We+"call-media-started",Je=We+"call-media-done",Ye="item-selected",Ke=r`
  .list {
...
const Et=(e,t,A)=>{for(const A of t)if(A[0]===e)return(0,A[1])();return A?.()};class Bt{constructor(e,t,A,i){this.hass=e,this.currentSection=t,this.card=A,this.config=i}async callMediaService(e,t){this.card.dispatchEvent(tt(qe,{section:this.currentSection}));try{await this.hass.callService("media_player",e,t)}finally{this.card.dispatchEvent(tt(Je))}}async browseMedia(e,t,A){var i;const s=await this.hass.callWS({type:"media_player/browse_media",entity_id:e.id,media_content_id:A,media_content_type:t});return this.config.replaceHttpWithHttpsForThumbnails&&(s.children=null===(i=s.children)||void 0===i?void 0:i.map((e=>{var t;return Object.assign(Object.assign({},e),{thumbnail:null===(t=e.thumbnail)||void 0===t?void 0:t.replace("http://","https://")})}))),s}async getRelatedEntities(e,...t){return new Promise((async(A,i)=>{const s={type:"render_template",template:"{{ device_entities(device_id('"+e.id+"')) }}"};try{const e=await this.hass.connection.subscribeMessage((i=>{e(),A(i.result.filter((e=>t.some((t=>e.includes(t))))).map((e=>this.hass.states[e])))}),s)}catch(e){i(e)}}))}}const Qt="data:image/png;base64,";function gt(e,t){for(const A in e)if(ut(A)===ut(t))return e[A]}function ut(e){return e.replace(/[^a-zA-Z ]/g,"")}function vt(e,t){let A=-1;return e.forEach(((e,i)=>{ut(e)===ut(t)&&(A=i)})),A}function pt(e,t){const A=e.some((e=>e.thumbnail));return e.map((e=>{const i=function(e,t,A){var i,s;let o=null!==(i=gt(t.customThumbnail,e.title))&&void 0!==i?i:e.thumbnail;return o?(null==o?void 0:o.match(/https:\/\/brands\.home-assistant\.io\/.+\/logo.png/))&&(o=null==o?void 0:o.replace("logo.png","icon.png")):(o=gt(t.customThumbnailIfMissing,e.title),A&&!o&&(o=(null===(s=t.customThumbnailIfMissing)||void 0===s?void 0:s.default)||Qt)),o||""}(e,t,A);return Object.assign(Object.assign({},e),{thumbnail:i})}))}function mt(e,t){return R`
  ...
  `}class Ct{constructor(e,t){this.hassService=e,this.config=t}async getFavorites(e){if(!e)return[];let t=await this.getFavoritesForPlayer(e);return t=t.flatMap((e=>e)),t=this.removeDuplicates(t),t=t.length?t:this.getFavoritesFromStates(e),t.filter((e=>{var t;return-1===vt(null!==(t=this.config.mediaBrowserTitlesToIgnore)&&void 0!==t?t:[],e.title)}))}removeDuplicates(e){return e.filter(((e,t,A)=>t===A.findIndex((t=>t.title===e.title))))}async getFavoritesForPlayer(e){var t;try{const A=null===(t=(await this.hassService.browseMedia(e,"favorites","")).children)||void 0===t?void 0:t.map((t=>this.hassService.browseMedia(e,t.media_content_type,t.media_content_id)));return(A?await Promise.all(A):[]).flatMap((e=>{var t;return null!==(t=e.children)&&void 0!==t?t:[]}))}catch(t){return console.log("Custom Sonos Card: error getting favorites for player "+e.id+": "+JSON.stringify(t)),[]}}getFavoritesFromStates(e){return(e.attributes.hasOwnProperty("source_list")?e.attributes.source_list:[]).map((e=>({title:e})))}}class yt{constructor(e,t){this.hassService=e,this.config=t}async join(e,t){await this.hassService.callMediaService("join",{entity_id:e,group_members:t})}async joinPredefinedGroup(e,t){const A=t.entities.map((({player:e})=>e.id));await this.join(e.id,A)}async unJoin(e){await this.hassService.callMediaService("unjoin",{entity_id:e})}async createGroup(e,t,A){let i;for(const s of t)if(e.entities.some((e=>e.player.id===s.id))){if(s.isPlaying())return void await this.modifyExistingGroup(s,e,A);i=i||s}if(i)await this.modifyExistingGroup(i,e,A);else{const{player:t}=e.entities[0];_e(t.id,this.config,A),await this.joinPredefinedGroup(t,e)}}async modifyExistingGroup(e,t,A){var i;const s=e.members.filter((e=>!t.entities.some((t=>t.player.id===e.id))));(null==s?void 0:s.length)&&await this.unJoin(s.map((e=>e.id))),_e(e.id,this.config,A),await this.joinPredefinedGroup(e,t);for(const e of t.entities){const A=null!==(i=e.volume)&&void 0!==i?i:t.volume;A&&await this.volumeSet(e.player,A,!1),t.unmuteWhenGrouped&&await this.setVolumeMute(e.player,!1,!1)}t.media&&await this.setSource(t.entities[0].player,t.media)}async volumeDown(e,t=!0){if(this.config.volumeStepSize){const A=100*e.attributes.volume_level,i=Math.max(0,A-this.config.volumeStepSize);await this.volumeSet(e,i,t)}else if(await this.hassService.callMediaService("volume_down",{entity_id:e.id}),t)for(const t of e.members)await this.hassService.callMediaService("volume_down",{entity_id:t.id})}async volumeUp(e,t=!0){if(this.config.volumeStepSize){const A=100*e.attributes.volume_level,i=Math.min(100,A+this.config.volumeStepSize);await this.volumeSet(e,i,t)}else if(await this.hassService.callMediaService("volume_up",{entity_id:e.id}),t)for(const t of e.members)await this.hassService.callMediaService("volume_up",{entity_id:t.id})}async volumeSet(e,t,A=!0){let i=t/100;await this.hassService.callMediaService("volume_set",{entity_id:e.id,volume_level:i});const s=i-e.attributes.volume_level;if(A)for(const t of e.members)this.config.adjustVolumeRelativeToMainPlayer&&(i=t.attributes.volume_level+s,i=Math.min(1,Math.max(0,i))),await this.hassService.callMediaService("volume_set",{entity_id:t.id,volume_level:i})}async toggleMute(e,t=!0){const A=!e.isMuted(t);await this.setVolumeMute(e,A,t)}async setVolumeMute(e,t,A=!0){if(await this.hassService.callMediaService("volume_mute",{entity_id:e.id,is_volume_muted:t}),A)for(const A of e.members)await this.hassService.callMediaService("volume_mute",{entity_id:A.id,is_volume_muted:t})}async setSource(e,t){await this.hassService.callMediaService("select_source",{source:t,entity_id:e.id})}async playMedia(e,t){await this.hassService.callMediaService("play_media",{entity_id:e.id,media_content_id:t.media_content_id,media_content_type:t.media_content_type})}async seek(e,t){await this.hassService.callMediaService("media_seek",{entity_id:e.id,seek_position:t})}}class bt{constructor(e,t,A){this.id=e.entity_id,this.config=t,this.name=this.getEntityName(e,t),this.state=e.state,this.attributes=e.attributes,this.members=A?this.createGroupMembers(e,A):[]}getPlayer(e){return this.id===e?this:this.getMember(e)}getMember(e){return this.members.find((t=>t.id===e))}hasMember(e){return void 0!==this.getMember(e)}isPlaying(){return"playing"===this.state}isMuted(e){return this.attributes.is_volume_muted&&(!e||this.members.every((e=>e.isMuted(!1))))}getCurrentTrack(){return`${this.attributes.media_artist||""} - ${this.attributes.media_title||""}`.replace(/^ - | - $/g,"")}getEntityName(e,t){const A=e.attributes.friendly_name||"";return t.entityNameRegexToReplace?A.replace(new RegExp(t.entityNameRegexToReplace,"g"),t.entityNameReplacement||""):A}createGroupMembers(e,t){const A=st(e);return t.filter((t=>A.includes(t.entity_id)&&e.entity_id!==t.entity_id)).map((e=>new bt(e,this.config)))}isGrouped(){return this.members.length>0}}class It{constructor(e,t,A,i,s){this.hass=e,this.config=t;const o=this.getMediaPlayerHassEntities(this.hass);this.allGroups=this.createPlayerGroups(o),this.allMediaPlayers=this.allGroups.reduce(((e,t)=>[...e,t,...t.members]),[]).sort(((e,t)=>e.name.localeCompare(t.name))),this.activePlayer=this.determineActivePlayer(s),this.hassService=new Bt(this.hass,A,i,t),this.mediaControlService=new yt(this.hassService,t),this.mediaBrowseService=new Ct(this.hassService,t),this.predefinedGroups=this.createPredefinedGroups()}createPredefinedGroups(){const e=[];if(this.config.predefinedGroups)for(const t of this.config.predefinedGroups){const A=this.createPredefinedGroup(t);A&&e.push(A)}return e}createPredefinedGroup(e){let t;const A=[];let i=e.entities;e.excludeItemsInEntitiesList&&(i=this.convertExclusionsInPredefinedGroupsToInclusions(i));for(const e of i){const t=this.createPredefinedGroupPlayer(e);t&&A.push(t)}return A.length&&(t=Object.assign(Object.assign({},e),{entities:A})),t}convertExclusionsInPredefinedGroupsToInclusions(e){return this.allMediaPlayers.filter((t=>!e.find((e=>("string"==typeof e?e:e.player)===t.id)))).map((e=>e.id))}createPredefinedGroupPlayer(e){var t;let A,i,s;if("string"==typeof e?A=e:(i=e.volume,A=e.player),"unavailable"!==(null===(t=this.hass.states[A])||void 0===t?void 0:t.state)){const e=this.allMediaPlayers.find((e=>e.id===A));e&&(s={player:e,volume:i})}return s}getMediaPlayerHassEntities(e){const t=e,A=[...new Set(this.config.entities)];return Object.values(e.states).filter((e=>{var i,s;if(e.entity_id.includes("media_player")){const o=null===(s=null===(i=t.entities)||void 0===i?void 0:i[e.entity_id])||void 0===s?void 0:s.platform;if(!o||this.config.showNonSonosPlayers||"sonos"===o){if(A.length){const t=A.includes(e.entity_id);return!!this.config.excludeItemsInEntitiesList!==t}return!0}}return!1})).sort(((e,t)=>e.entity_id.localeCompare(t.entity_id)))}createPlayerGroups(e){return e.filter((t=>this.isMainPlayer(t,e))).map((t=>this.createPlayerGroup(t,e))).filter((e=>void 0!==e))}isMainPlayer(e,t){var A;try{const i=st(e).filter((e=>t.some((t=>t.entity_id===e)))),s=(null==i?void 0:i.length)>1,o=s&&i&&i[0]===e.entity_id;return(!s||o)&&"unavailable"!==(null===(A=this.hass.states[e.entity_id])||void 0===A?void 0:A.state)}catch(t){return console.error("Failed to determine main player",JSON.stringify(e),t),!1}}createPlayerGroup(e,t){try{return new bt(e,this.config,t)}catch(t){return void console.error("Failed to create group",JSON.stringify(e),t)}}determineActivePlayer(e){const t=e||this.config.entityId||this.getActivePlayerFromUrl();return this.allGroups.find((e=>void 0!==e.getPlayer(t)))||this.allGroups.find((e=>e.isPlaying()))||this.allGroups[0]}getActivePlayerFromUrl(){return window.location.href.includes("#")?window.location.href.replace(/.*#/g,""):""}}const{GROUPING:wt,GROUPS:Pt,MEDIA_BROWSER:St,PLAYER:Lt,VOLUMES:Ot}=he;class Vt extends oe{render(){return R`
    ...
    `}valueChanged(e){const t=e.detail.value;this.config=Object.assign(Object.assign({},this.config),t),this.configChanged()}}function qt({help:e,label:t,name:A}){if(t)return t;let i=A.replace(/([A-Z])/g," $1");return i=i.charAt(0).toUpperCase()+i.slice(1),i+(e?` (${e})`:"")}e([le({attribute:!1})],Zt.prototype,"schema",void 0),e([le({attribute:!1})],Zt.prototype,"data",void 0),e([le()],Zt.prototype,"changed",void 0),customElements.define("sonos-card-editor-form",Zt);const{GENERAL:Jt,ENTITIES:Yt,ADVANCED:Kt,ARTWORK:Ft}=zt;class $t extends kt{constructor(){super(...arguments),this.configArea=Jt}render(){return this.config.sections&&0!==this.config.sections.length||(this.config.sections=[he.PLAYER,he.VOLUMES,he.GROUPS,he.GROUPING,he.MEDIA_BROWSER]),R`
      ...
      ${this.subEditor()}
    `}subEditor(){return Et(this.configArea,[[Jt,()=>R`<sonos-card-general-editor .config=${this.config} .hass=${this.hass}></sonos-card-general-editor>`],[Yt,()=>R`<sonos-card-entities-editor .config=${this.config} .hass=${this.hass}></sonos-card-entities-editor>`],[Kt,()=>R`<sonos-card-advanced-editor .config=${this.config} .hass=${this.hass}></sonos-card-advanced-editor>`],[Ft,()=>R`<sonos-card-artwork-overrides-editor
            .config=${this.config}
            .hass=${this.hass}
    ...
    `}static get styles(){return[Ke,r`
      ...
      `]}itemClick(e){e.isDisabled||(this.modifiedItems.includes(e.player.id)?this.modifiedItems=this.modifiedItems.filter((t=>t!==e.player.id)):this.modifiedItems=[...this.modifiedItems,e.player.id])}async applyGrouping(){const e=this.groupingItems.filter((e=>e.isSelected)),t=this.groupingItems.filter((e=>!e.isSelected&&this.joinedPlayers.includes(e.player.id))).map((e=>e.player.id)),A=this.groupingItems.filter((e=>e.isSelected&&!this.joinedPlayers.includes(e.player.id))).map((e=>e.player.id));let i=this.activePlayer.id;t.includes(this.activePlayer.id)&&(i=e[0].player.id,_e(i,this.store.config,this)),t.length>0&&await this.mediaControlService.unJoin(t),A.length>0&&await this.mediaControlService.join(i,A),this.modifiedItems=[]}cancelGrouping(){this.groupingItems=this.getGroupingItems()}getGroupingItems(){const e=this.store.allMediaPlayers.map((e=>new nA(e,this.activePlayer,this.modifiedItems.includes(e.id)))),t=e.filter((e=>e.isSelected));return 1===t.length&&(t[0].isDisabled=!0),e}renderJoinAllButton(){return me(this.notJoinedPlayers.length,(()=>R`
        <sonos-grouping-button
          @click=${async()=>await this.mediaControlService.join(this.activePlayer.id,this.notJoinedPlayers)}
          .icon=${"mdi:checkbox-multiple-marked-outline"}
        ></sonos-grouping-button>
      `))}getNotJoinedPlayers(){return this.mediaPlayerIds.filter((e=>e!==this.activePlayer.id&&!this.activePlayer.hasMember(e)))}renderUnJoinAllButton(){return me(this.joinedPlayers.length,(()=>R`
        <sonos-grouping-button
    ...
    `}static get styles(){return Ke}}e([le({attribute:!1})],lA.prototype,"store",void 0);class cA extends oe{render(){return this.config=this.store.config,R`
    ...
    `}static get styles(){return[r`
      ...
      `,Fe,Ke]}}e([le({attribute:!1})],cA.prototype,"store",void 0),e([le({type:Array})],cA.prototype,"items",void 0),customElements.define("sonos-media-browser-list",cA);class dA extends oe{render(){return this.config=this.store.config,R`
      <style>
        :host {
    ...
    `}}e([le({attribute:!1})],hA.prototype,"store",void 0),customElements.define("sonos-media-browser-header",hA);class EA extends oe{constructor(){super(...arguments),this.onMediaItemSelected=e=>{const t=e.detail;this.playItem(t),this.dispatchEvent(tt(Ye,t))}}render(){return this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaBrowseService=this.store.mediaBrowseService,this.mediaControlService=this.store.mediaControlService,R`
