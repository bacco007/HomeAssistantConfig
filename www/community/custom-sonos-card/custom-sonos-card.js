 ...
 */const Me=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,ke=1073741823;const He=fe(class extends Ve{constructor(){super(...arguments),this.wt=ke,this.bt=[],this.K=new Le(this),this.X=new Oe}render(...e){return e.find((e=>!Me(e)))??G}update(e,t){const A=this.bt;let i=A.length;this.bt=t;const s=this.K,o=this.X;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this.wt);e++){const r=t[e];if(!Me(r))return this.wt=e,r;e<i&&r===A[e]||(this.wt=ke,i=0,Promise.resolve(r).then((async e=>{for(;o.get();)await o.get();const t=s.deref();if(void 0!==t){const A=t.bt.indexOf(r);A>-1&&A<t.wt&&(t.wt=A,t.setValue(e))}})))}return G}disconnected(){this.K.disconnect(),this.X.pause()}reconnected(){this.K.reconnect(this),this.X.resume()}}),{SHUFFLE_SET:ze,REPEAT_SET:Ne,PLAY:xe,PAUSE:Te,NEXT_TRACK:Ue,PREVIOUS_TRACK:Xe,BROWSE_MEDIA:Re}=he;class je extends se{constructor(){super(...arguments),this.volDown=async()=>await this.mediaControlService.volumeDown(this.volumePlayer,!this.config.playerVolumeEntityId),this.volUp=async()=>await this.mediaControlService.volumeUp(this.volumePlayer,!this.config.playerVolumeEntityId),this.rewind=async()=>await this.mediaControlService.seek(this.volumePlayer,this.volumePlayer.attributes.media_position-(this.config.fastForwardAndRewindStepSizeSeconds||15)),this.fastForward=async()=>await this.mediaControlService.seek(this.volumePlayer,this.volumePlayer.attributes.media_position+(this.config.fastForwardAndRewindStepSizeSeconds||15))}render(){var e;this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaControlService=this.store.mediaControlService;const t=!!this.config.showVolumeUpAndDownButtons&&W,A=!!this.config.showFastForwardAndRewindButtons&&W;return this.volumePlayer=null!==(e=this.activePlayer.getMember(this.config.playerVolumeEntityId))&&void 0!==e?e:this.activePlayer,j`
  ...
  `}async getAudioInputFormat(){const e=(await this.store.hassService.getRelatedEntities(this.activePlayer,"sensor")).find((e=>e.entity_id.includes("audio_input_format")));return e&&e.state&&"No audio"!==e.state?j`<div>${e.state}</div>`:""}showShuffle(){return this.config.hidePlayerControlShuffleButton?[]:[ze]}showPrev(){return this.config.hidePlayerControlPrevTrackButton?[]:[Xe]}showNext(){return this.config.hidePlayerControlNextTrackButton?[]:[Ue]}showRepeat(){return this.config.hidePlayerControlRepeatButton?[]:[Ne]}showBrowseMedia(){return this.config.showBrowseMediaInPlayerSection?[Re]:[]}static get styles(){return r`
      .main {
...
const Et=(e,t,A)=>{for(const A of t)if(A[0]===e)return(0,A[1])();return A?.()};class gt{constructor(e,t,A,i){this.hass=e,this.currentSection=t,this.card=A,this.config=i}async callMediaService(e,t){this.card.dispatchEvent(tt(qe,{section:this.currentSection}));try{await this.hass.callService("media_player",e,t)}finally{this.card.dispatchEvent(tt(Ze))}}async browseMedia(e,t,A){var i;const s=await this.hass.callWS({type:"media_player/browse_media",entity_id:e.id,media_content_id:A,media_content_type:t});return this.config.replaceHttpWithHttpsForThumbnails&&(s.children=null===(i=s.children)||void 0===i?void 0:i.map((e=>{var t;return Object.assign(Object.assign({},e),{thumbnail:null===(t=e.thumbnail)||void 0===t?void 0:t.replace("http://","https://")})}))),s}async getRelatedEntities(e,...t){return new Promise((async(A,i)=>{const s={type:"render_template",template:"{{ device_entities(device_id('"+e.id+"')) }}"};try{const e=await this.hass.connection.subscribeMessage((i=>{e(),A(i.result.filter((e=>t.some((t=>e.includes(t))))).map((e=>this.hass.states[e])))}),s)}catch(e){i(e)}}))}}const Bt="data:image/png;base64,";function ut(e,t){for(const A in e)if(Qt(A)===Qt(t))return e[A]}function Qt(e){return e.replace(/[^a-zA-Z ]/g,"")}function pt(e,t){let A=-1;return e.forEach(((e,i)=>{Qt(e)===Qt(t)&&(A=i)})),A}function mt(e,t){const A=e.some((e=>e.thumbnail));return e.map((e=>{const i=function(e,t,A){var i,s;let o=null!==(i=ut(t.customThumbnail,e.title))&&void 0!==i?i:e.thumbnail;return o?(null==o?void 0:o.match(/https:\/\/brands\.home-assistant\.io\/.+\/logo.png/))&&(o=null==o?void 0:o.replace("logo.png","icon.png")):(o=ut(t.customThumbnailIfMissing,e.title),A&&!o&&(o=(null===(s=t.customThumbnailIfMissing)||void 0===s?void 0:s.default)||Bt)),o||""}(e,t,A);return Object.assign(Object.assign({},e),{thumbnail:i})}))}function vt(e,t=!0){return j`
  ...
  `}class ft{constructor(e,t){this.hassService=e,this.config=t}async getFavorites(e){if(!e)return[];let t=await this.getFavoritesForPlayer(e);return t=t.flatMap((e=>e)),t=this.removeDuplicates(t),t=t.length?t:this.getFavoritesFromStates(e),t.filter((e=>{var t;return-1===pt(null!==(t=this.config.favoritesToIgnore)&&void 0!==t?t:[],e.title)}))}removeDuplicates(e){return e.filter(((e,t,A)=>t===A.findIndex((t=>t.title===e.title))))}async getFavoritesForPlayer(e){var t;try{const A=null===(t=(await this.hassService.browseMedia(e,"favorites","")).children)||void 0===t?void 0:t.map((t=>this.hassService.browseMedia(e,t.media_content_type,t.media_content_id)));return(A?await Promise.all(A):[]).flatMap((e=>{var t;return null!==(t=e.children)&&void 0!==t?t:[]}))}catch(t){return console.log(`Sonos Card: error getting favorites for player ${e.id}: ${JSON.stringify(t)}`),[]}}getFavoritesFromStates(e){return(e.attributes.hasOwnProperty("source_list")?e.attributes.source_list:[]).map((e=>({title:e})))}}class Ct{constructor(e,t){this.hassService=e,this.config=t}async join(e,t){await this.hassService.callMediaService("join",{entity_id:e,group_members:t})}async unJoin(e){await this.hassService.callMediaService("unjoin",{entity_id:e})}async setVolumeAndMediaForPredefinedGroup(e){var t;for(const A of e.entities){const i=null!==(t=A.volume)&&void 0!==t?t:e.volume;i&&await this.volumeSetSinglePlayer(A.player,i),e.unmuteWhenGrouped&&await this.setVolumeMute(A.player,!1,!1)}e.media&&await this.setSource(e.entities[0].player,e.media)}async volumeDown(e,t=!0){await this.volumeStep(e,t,this.getStepDownVolume,"volume_down")}async volumeUp(e,t=!0){await this.volumeStep(e,t,this.getStepUpVolume,"volume_up")}async volumeStep(e,t,A,i){this.config.volumeStepSize?await this.volumeWithStepSize(e,t,this.config.volumeStepSize,A):await this.volumeDefaultStep(e,t,i)}async volumeWithStepSize(e,t,A,i){for(const s of e.members)if(e.id===s.id||t){const e=i(s,A);await this.volumeSetSinglePlayer(s,e)}}getStepDownVolume(e,t){return Math.max(0,e.getVolume()-t)}getStepUpVolume(e,t){return Math.min(100,e.getVolume()+t)}async volumeDefaultStep(e,t,A){for(const i of e.members)(e.id===i.id||t)&&(i.ignoreVolume||await this.hassService.callMediaService(A,{entity_id:i.id}))}async volumeSet(e,t,A){return A?await this.volumeSetGroup(e,t):await this.volumeSetSinglePlayer(e,t)}async volumeSetGroup(e,t){let A;this.config.adjustVolumeRelativeToMainPlayer&&(A=t/e.getVolume()),await Promise.all(e.members.map((e=>{let i=t;return void 0!==A&&this.config.adjustVolumeRelativeToMainPlayer&&(i=e.getVolume()*A,i=Math.min(100,Math.max(0,i))),this.volumeSetSinglePlayer(e,i)})))}async volumeSetSinglePlayer(e,t){if(!e.ignoreVolume){const A=t/100;await this.hassService.callMediaService("volume_set",{entity_id:e.id,volume_level:A})}}async toggleMute(e,t=!0){const A=!e.isMuted(t);await this.setVolumeMute(e,A,t)}async setVolumeMute(e,t,A=!0){for(const i of e.members)(e.id===i.id||A)&&await this.hassService.callMediaService("volume_mute",{entity_id:i.id,is_volume_muted:t})}async setSource(e,t){await this.hassService.callMediaService("select_source",{source:t,entity_id:e.id})}async playMedia(e,t){await this.hassService.callMediaService("play_media",{entity_id:e.id,media_content_id:t.media_content_id,media_content_type:t.media_content_type})}async seek(e,t){await this.hassService.callMediaService("media_seek",{entity_id:e.id,seek_position:t})}}class yt{constructor(e,t,A){var i;this.id=e.entity_id,this.config=t,this.name=this.getEntityName(e,t),this.state=e.state,this.attributes=e.attributes,this.members=A?this.createGroupMembers(e,A):[this],this.volumePlayer=this.determineVolumePlayer(),this.ignoreVolume=!!(null===(i=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===i?void 0:i.includes(this.volumePlayer.id))}getMember(e){return this.members.find((t=>t.id===e))}hasMember(e){return void 0!==this.getMember(e)}isPlaying(){return"playing"===this.state}isMuted(e){return this.attributes.is_volume_muted&&(!e||this.members.every((e=>e.isMuted(!1))))}getCurrentTrack(){return`${this.attributes.media_artist||""} - ${this.attributes.media_title||""}`.replace(/^ - | - $/g,"")}getEntityName(e,t){const A=e.attributes.friendly_name||"";return t.entityNameRegexToReplace?A.replace(new RegExp(t.entityNameRegexToReplace,"g"),t.entityNameReplacement||""):A}createGroupMembers(e,t){return st(e).reduce(((e,A)=>{const i=t.find((e=>e.entity_id===A));return i?[...e,new yt(i,this.config)]:e}),[])}determineVolumePlayer(){let e;return this.members.length>1&&this.config.entitiesToIgnoreVolumeLevelFor&&(e=this.members.find((e=>{var t;return!(null===(t=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===t?void 0:t.includes(e.id))}))),null!=e?e:this}getVolume(){let e;return e=this.members.length>1&&this.config.adjustVolumeRelativeToMainPlayer?this.getAverageVolume():100*this.volumePlayer.attributes.volume_level,Math.round(e)}getAverageVolume(){const e=this.members.filter((e=>{var t;return!(null===(t=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===t?void 0:t.includes(e.id))})).map((e=>e.attributes.volume_level));return 100*e.reduce(((e,t)=>e+t),0)/e.length}}const{TURN_OFF:bt,TURN_ON:It}=he;class wt{constructor(e,t,A,i,s){this.hass=e,this.config=t;const o=this.getMediaPlayerHassEntities(this.hass);this.allGroups=this.createPlayerGroups(o),this.allMediaPlayers=this.allGroups.reduce(((e,t)=>[...e,...t.members]),[]).sort(((e,t)=>e.name.localeCompare(t.name))),this.activePlayer=this.determineActivePlayer(s),this.hassService=new gt(this.hass,A,i,t),this.mediaControlService=new Ct(this.hassService,t),this.mediaBrowseService=new ft(this.hassService,t),this.predefinedGroups=this.createPredefinedGroups()}createPredefinedGroups(){const e=[];if(this.config.predefinedGroups)for(const t of this.config.predefinedGroups){const A=this.createPredefinedGroup(t);A&&e.push(A)}return e}createPredefinedGroup(e){let t;const A=[];let i=e.entities;e.excludeItemsInEntitiesList&&(i=this.convertExclusionsInPredefinedGroupsToInclusions(i));for(const e of i){const t=this.createPredefinedGroupPlayer(e);t&&A.push(t)}return A.length&&(t=Object.assign(Object.assign({},e),{entities:A})),t}convertExclusionsInPredefinedGroupsToInclusions(e){return this.allMediaPlayers.filter((t=>!e.find((e=>("string"==typeof e?e:e.player)===t.id)))).map((e=>e.id))}createPredefinedGroupPlayer(e){var t;let A,i,s;if("string"==typeof e?A=e:(i=e.volume,A=e.player),"unavailable"!==(null===(t=this.hass.states[A])||void 0===t?void 0:t.state)){const e=this.allMediaPlayers.find((e=>e.id===A));e&&(s={player:e,volume:i})}else console.warn(`Player ${A} is unavailable`);return s}getMediaPlayerHassEntities(e){const t=e,A=[...new Set(this.config.entities)];return Object.values(e.states).filter((e=>{var i,s;if(e.entity_id.includes("media_player")){if(A.length){const t=A.includes(e.entity_id);return!!this.config.excludeItemsInEntitiesList!==t}if(this.config.entityPlatform){return(null===(s=null===(i=t.entities)||void 0===i?void 0:i[e.entity_id])||void 0===s?void 0:s.platform)===this.config.entityPlatform}return!0}return!1})).sort(((e,t)=>e.entity_id.localeCompare(t.entity_id)))}createPlayerGroups(e){return e.filter((t=>this.isMainPlayer(t,e))).map((t=>this.createPlayerGroup(t,e))).filter((e=>void 0!==e))}isMainPlayer(e,t){var A;try{const i=st(e).filter((e=>t.some((t=>t.entity_id===e)))),s=(null==i?void 0:i.length)>1,o=s&&i&&i[0]===e.entity_id,r="unavailable"!==(null===(A=this.hass.states[e.entity_id])||void 0===A?void 0:A.state);return r||console.warn(`Player ${e.entity_id} is unavailable`),(!s||o)&&r}catch(t){return console.error("Failed to determine main player",JSON.stringify(e),t),!1}}createPlayerGroup(e,t){try{return new yt(e,this.config,t)}catch(t){return void console.error("Failed to create group",JSON.stringify(e),t)}}determineActivePlayer(e){const t=e||this.config.entityId||this.getActivePlayerFromUrl();return this.allGroups.find((e=>void 0!==e.getMember(t)))||this.allGroups.find((e=>e.isPlaying()))||this.allGroups[0]}getActivePlayerFromUrl(){return window.location.href.includes("#")?window.location.href.replace(/.*#/g,""):""}showPower(e=!1){return this.config.hidePlayerControlPowerButton?[]:((this.activePlayer.attributes.supported_features||0)&Ke)!=Ke||e&&"off"!==this.activePlayer.state?[]:[It,bt]}}const{GROUPING:Pt,GROUPS:St,MEDIA_BROWSER:Vt,PLAYER:Lt,VOLUMES:Ot}=de;class Mt extends se{render(){return j`
    ...
    `}changed(e){const t=e.detail.value;this.config=Object.assign(Object.assign(Object.assign({},this.config),t),{topFavorites:t.topFavorites.split(/ *, */)}),this.configChanged()}});class Tt extends Nt{render(){return j``}}e([ae({type:Number})],Tt.prototype,"index",void 0),customElements.define("sonos-card-custom-source-editor",Tt);const Ut=[{type:"multi_select",options:{player:"Player","media browser":"Media Browser",groups:"Groups",grouping:"Grouping",volumes:"Volumes"},name:"sections"},{type:"integer",name:"mediaBrowserItemsPerRow",default:4,required:!0,valueMin:1,valueMax:30},{type:"string",name:"title"},{name:"showVolumeUpAndDownButtons",selector:{boolean:{}}},{name:"showFastForwardAndRewindButtons",selector:{boolean:{}}},{name:"fastForwardAndRewindStepSizeSeconds",type:"integer",default:15,required:!0},{name:"hidePlayerControlPowerButton",selector:{boolean:{}}},{name:"hidePlayerControlShuffleButton",selector:{boolean:{}}},{name:"hidePlayerControlPrevTrackButton",selector:{boolean:{}}},{name:"hidePlayerControlNextTrackButton",selector:{boolean:{}}},{name:"hidePlayerControlRepeatButton",selector:{boolean:{}}},{type:"integer",name:"widthPercentage",default:100,required:!0},{type:"integer",name:"heightPercentage",default:100,required:!0}];customElements.define("sonos-card-general-editor",class extends Nt{render(){return j`
      <sonos-card-editor-form
        .schema=${Ut}
        .config=${this.config}
        .hass=${this.hass}
      ></sonos-card-editor-form>
    `}});const Xt=[{type:"string",name:"entityNameRegexToReplace"},{type:"string",name:"entityNameReplacement"},{type:"boolean",name:"excludeItemsInEntitiesList"}],Rt=[{name:"showNonSonosPlayers",help:"Show all media players, including those that are not on the Sonos platform",selector:{boolean:{}}},{name:"entityId",help:"Not needed, but forces this player to be the selected one on loading the card (overrides url param etc)",selector:{entity:{multiple:!1,filter:{domain:"media_player"}}}},{name:"entities",help:"Required, unless you have specified entity platform",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}}];class jt extends Nt{constructor(){super(...arguments),this.entitiesSchema=Rt}render(){const e=this.config.predefinedGroups;return this.entitiesSchema[0].help="Not needed, unless you don't want to include all of them",this.editGroup>-1?j`<sonos-card-predefined-group-editor
        ...
        `}}e([le()],jt.prototype,"editGroup",void 0),customElements.define("sonos-card-entities-editor",jt);class Gt extends Nt{constructor(){super(...arguments),this.schema=[{type:"string",name:"name",required:!0},{type:"string",name:"media"},{type:"boolean",name:"excludeItemsInEntitiesList"},{name:"entities",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}}]}render(){return this.predefinedGroup||this.initPredefinedGroup(),j`
    ...
    `}initPredefinedGroup(){var e;const t=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e[this.index||0];if(t){const e=t.entities.map((e=>"string"==typeof e?{player:e}:e));this.predefinedGroup=Object.assign(Object.assign({},t),{entities:e})}else this.predefinedGroup={name:"",media:"",entities:[]}}getPredefinedGroupWithoutVolumes(){return Object.assign(Object.assign({},this.predefinedGroup),{entities:this.predefinedGroup.entities.map((e=>e.player))})}groupChanged(e){const t=e.detail.value,A=t.entities.map((e=>{const t=this.predefinedGroup.entities.find((({player:t})=>t===e));return null!=t?t:{player:e}}));this.predefinedGroup=Object.assign(Object.assign({},t),{entities:A})}volumeChanged(e,t){const A=e.detail.value.volume,i=this.predefinedGroup.entities.map((e=>e.player===t?Object.assign(Object.assign({},e),{volume:A}):e));this.predefinedGroup=Object.assign(Object.assign({},this.predefinedGroup),{entities:i})}savePredefinedGroup(){let e=this.config.predefinedGroups;Array.isArray(e)||(e=[]),e[this.index]?e[this.index]=this.predefinedGroup:e=[...e,this.predefinedGroup],this.config.predefinedGroups=e,this.configChanged(),this.dispatchClose()}deletePredefinedGroup(){var e;this.config.predefinedGroups=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e.filter(((e,t)=>t!==this.index)),this.index=-1,this.configChanged(),this.dispatchClose()}}e([ae({type:Number})],Gt.prototype,"index",void 0),e([le()],Gt.prototype,"predefinedGroup",void 0),customElements.define("sonos-card-predefined-group-editor",Gt);class Wt extends Nt{render(){const e=this.config.mediaArtworkOverrides;return this.editItem>-1?j`<sonos-card-artwork-override-editor
        ...
        `}}e([le()],Wt.prototype,"editItem",void 0),customElements.define("sonos-card-artwork-overrides-editor",Wt);const Dt={ifMissing:!1};class qt extends Nt{render(){var e;const t=null===(e=this.config.mediaArtworkOverrides)||void 0===e?void 0:e[this.index||0];return j`
