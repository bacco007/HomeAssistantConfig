 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const He=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,ze=1073741823;const Ne=ye(class extends Oe{constructor(){super(...arguments),this._$Cwt=ze,this._$Cbt=[],this._$CK=new Me(this),this._$CX=new ke}render(...e){return e.find((e=>!He(e)))??G}update(e,t){const A=this._$Cbt;let i=A.length;this._$Cbt=t;const s=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){const r=t[e];if(!He(r))return this._$Cwt=e,r;e<i&&r===A[e]||(this._$Cwt=ze,i=0,Promise.resolve(r).then((async e=>{for(;o.get();)await o.get();const t=s.deref();if(void 0!==t){const A=t._$Cbt.indexOf(r);A>-1&&A<t._$Cwt&&(t._$Cwt=A,t.setValue(e))}})))}return G}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),{SHUFFLE_SET:xe,REPEAT_SET:Te,PLAY:Ue,PAUSE:Xe,NEXT_TRACK:je,PREVIOUS_TRACK:Re}=Ee;class Ge extends oe{constructor(){super(...arguments),this.volDown=async()=>await this.mediaControlService.volumeDown(this.volumePlayer,!this.config.playerVolumeEntityId),this.volUp=async()=>await this.mediaControlService.volumeUp(this.volumePlayer,!this.config.playerVolumeEntityId)}render(){var e;this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaControlService=this.store.mediaControlService;const t=!!this.config.showVolumeUpAndDownButtons&&W;return this.volumePlayer=null!==(e=this.activePlayer.getMember(this.config.playerVolumeEntityId))&&void 0!==e?e:this.activePlayer,R`
      <div class="main" id="mediaControls">
        ${ve(["paused","playing"].includes(this.activePlayer.state),(()=>R`
            <div class="icons">
    ...
    `}}e([le({attribute:!1})],Ge.prototype,"store",void 0),customElements.define("sonos-player-controls",Ge);const We="sonos-card-dispatch-event-",De="active-player",qe=We+De,Ze=We+"call-media-started",Ye=We+"call-media-done",Je="item-selected",Fe=r`
  .list {
    ...
    `}initPredefinedGroup(){var e;const t=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e[this.index||0];if(t){const e=t.entities.map((e=>"string"==typeof e?{player:e}:e));this.predefinedGroup=Object.assign(Object.assign({},t),{entities:e})}else this.predefinedGroup={name:"",media:"",entities:[]}}getPredefinedGroupWithoutVolumes(){return Object.assign(Object.assign({},this.predefinedGroup),{entities:this.predefinedGroup.entities.map((e=>e.player))})}groupChanged(e){const t=e.detail.value,A=t.entities.map((e=>{const t=this.predefinedGroup.entities.find((({player:t})=>t===e));return null!=t?t:{player:e}}));this.predefinedGroup=Object.assign(Object.assign({},t),{entities:A})}volumeChanged(e,t){const A=e.detail.value.volume,i=this.predefinedGroup.entities.map((e=>e.player===t?Object.assign(Object.assign({},e),{volume:A}):e));this.predefinedGroup=Object.assign(Object.assign({},this.predefinedGroup),{entities:i})}savePredefinedGroup(){let e=this.config.predefinedGroups;Array.isArray(e)||(e=[]),e[this.index]?e[this.index]=this.predefinedGroup:e=[...e,this.predefinedGroup],this.config.predefinedGroups=e,this.configChanged(),this.dispatchClose()}deletePredefinedGroup(){var e;this.config.predefinedGroups=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e.filter(((e,t)=>t!==this.index)),this.index=-1,this.configChanged(),this.dispatchClose()}}e([le({type:Number})],Wt.prototype,"index",void 0),e([ce()],Wt.prototype,"predefinedGroup",void 0),customElements.define("sonos-card-predefined-group-editor",Wt);class Dt extends xt{render(){const e=this.config.mediaArtworkOverrides;return this.editItem>-1?R`<sonos-card-artwork-override-editor
        ...
        ></sonos-card-artwork-override-editor>`:R`
          <div>
            Artwork Overrides
            <ha-control-button-group>
              ${null==e?void 0:e.map(((e,t)=>{const A=e.mediaTitleEquals||e.mediaArtistEquals||e.mediaAlbumNameEquals||e.mediaContentIdEquals||e.mediaChannelEquals||e.ifMissing&&"if missing"||t;return R`
        ...
        `}}e([ce()],Dt.prototype,"editItem",void 0),customElements.define("sonos-card-artwork-overrides-editor",Dt);const qt={ifMissing:!1};class Zt extends xt{render(){var e;const t=null===(e=this.config.mediaArtworkOverrides)||void 0===e?void 0:e[this.index||0];return R`
