 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function me(e,t,A){return e?t(e):A?.(e)}const{SHUFFLE_SET:fe,REPEAT_SET:Ce,PLAY:ye,PAUSE:be,NEXT_TRACK:Ie,PREVIOUS_TRACK:we}=Be;class Pe extends re{constructor(){super(...arguments),this.volDown=async()=>await this.mediaControlService.volumeDown(this.activePlayer),this.volUp=async()=>await this.mediaControlService.volumeUp(this.activePlayer)}render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaControlService=this.store.mediaControlService;const e=this.config.showVolumeUpAndDownButtons&&W;return G`
    ...
    `}}e([le({attribute:!1})],Pe.prototype,"store",void 0),customElements.define("sonos-player-controls",Pe);const Se="sonos-card-dispatch-event-",Le=Se+"active-player",Oe=Se+"request-player",Ve=Se+"show-section",Me=Se+"call-media-started",He=Se+"call-media-done",ze=Se+"media-item-selected",ke=o`
  .list {
...
`;function Te(e,t=[]){const A=[e.id,...e.members.map((e=>e.id))].sort();if(null==t?void 0:t.length){const e=t.find((e=>e.entities.map((e=>e.player.id)).sort().toString()===A.toString()));if(e)return e.name}return[e.name,...e.members.map((e=>e.name))].join(" + ")}function Xe(e){Ue(Le,{entityId:e})}function Ue(e,t){const A=new CustomEvent(e,{bubbles:!0,composed:!0,detail:t});window.dispatchEvent(A)}const xe=40;function je(e){return e?e/100*xe:xe}function Ge(e){return e.attributes.sonos_group||e.attributes.group_members}class Re extends re{render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer;const e=Te(this.activePlayer,this.store.predefinedGroups);let t=this.config.labelWhenNoMediaIsSelected?this.config.labelWhenNoMediaIsSelected:"No media selected";return"idle"!==this.activePlayer.state&&(t=this.activePlayer.getCurrentTrack()),G` <div class="info">
    ...
    `}}e([le({attribute:!1})],Re.prototype,"store",void 0),customElements.define("sonos-player-header",Re);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const We=1,De=2,Ze=e=>(...t)=>({_$litDirective$:e,values:t});class qe{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,A){this._$Ct=e,this._$AM=t,this._$Ci=A}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ye="important",Je=" !"+Ye,Ke=Ze(class extends qe{constructor(e){if(super(e),e.type!==We||"style"!==e.name||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,A)=>{const i=e[A];return null==i?t:t+`${A=A.includes("-")?A:A.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(e,[t]){const{style:A}=e.element;if(void 0===this.ut)return this.ut=new Set(Object.keys(t)),this.render(t);for(const e of this.ut)null==t[e]&&(this.ut.delete(e),e.includes("-")?A.removeProperty(e):A[e]=null);for(const e in t){const i=t[e];if(null!=i){this.ut.add(e);const t="string"==typeof i&&i.endsWith(Je);e.includes("-")||t?A.setProperty(e,t?i.slice(0,-11):i,t?Ye:""):A[e]=i}}return R}});class Fe extends re{constructor(){super(...arguments),this.mediaDuration=0}disconnectedCallback(){this.tracker&&(clearInterval(this.tracker),this.tracker=void 0),super.disconnectedCallback()}render(){var e;this.activePlayer=this.store.activePlayer,this.mediaDuration=(null===(e=this.activePlayer)||void 0===e?void 0:e.attributes.media_duration)||0;return this.mediaDuration>0?(this.trackProgress(),G`
        <div class="progress">
          <span>${$e(this.playingProgress)}</span>
          <div class="bar" @click=${this.handleSeek}>
            <div class="progress-bar" style=${this.progressBarStyle(this.mediaDuration)}></div>
          </div>
          <span> -${$e(this.mediaDuration-this.playingProgress)}</span>
        </div>
      `):G``}async handleSeek(e){const t=this.progressBar.offsetWidth,A=e.offsetX/t,i=this.mediaDuration*A;await this.store.mediaControlService.seek(this.activePlayer,i)}progressBarStyle(e){return Ke({width:this.playingProgress/e*100+"%"})}trackProgress(){var e,t,A;const i=(null===(e=this.activePlayer)||void 0===e?void 0:e.attributes.media_position)||0,s=null===(t=this.activePlayer)||void 0===t?void 0:t.isPlaying(),r=(null===(A=this.activePlayer)||void 0===A?void 0:A.attributes.media_position_updated_at)||0;this.playingProgress=s?i+(Date.now()-new Date(r).getTime())/1e3:i,this.tracker||(this.tracker=setInterval((()=>this.trackProgress()),1e3)),s||(clearInterval(this.tracker),this.tracker=void 0)}static get styles(){return o`
      .progress {
        width: 100%;
        font-size: x-small;
        display: flex;
    ...
    `}}e([le({attribute:!1})],Fe.prototype,"store",void 0),e([ce()],Fe.prototype,"playingProgress",void 0),e([function(e,t){return(A,i,s)=>{const r=t=>t.renderRoot?.querySelector(e)??null;if(t){const{get:e,set:o}="object"==typeof i?A:s??(()=>{const e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return de(A,i,{get(){if(t){let t=e.call(this);return void 0===t&&(t=r(this),o.call(this,t)),t}return r(this)}})}return de(A,i,{get(){return r(this)}})}}(".bar")],Fe.prototype,"progressBar",void 0);const $e=e=>{const t=new Date(1e3*e).toISOString().substring(11,19);return t.startsWith("00:")?t.substring(3):t};customElements.define("sonos-progress",Fe);class _e extends re{constructor(){super(...arguments),this.updateMembers=!0}render(){this.config=this.store.config,this.mediaControlService=this.store.mediaControlService;const e=100*this.player.attributes.volume_level,t=e<20&&this.config.dynamicVolumeSlider?30:100,A=this.player.isMuted(this.updateMembers)?"M3,9H7L12,4V20L7,15H3V9M16.59,12L14,9.41L15.41,8L18,10.59L20.59,8L22,9.41L19.41,12L22,14.59L20.59,16L18,13.41L15.41,16L14,14.59L16.59,12Z":"M14,3.23V5.29C16.89,6.15 19,8.83 19,12C19,15.17 16.89,17.84 14,18.7V20.77C18,19.86 21,16.28 21,12C21,7.72 18,4.14 14,3.23M16.5,12C16.5,10.23 15.5,8.71 14,7.97V16C15.5,15.29 16.5,13.76 16.5,12M3,9V15H7L12,20V4L7,9H3Z";return G`
      <div class="volume">
    ...
    `}}e([le({attribute:!1})],_e.prototype,"store",void 0),e([le({attribute:!1})],_e.prototype,"player",void 0),e([le({type:Boolean})],_e.prototype,"updateMembers",void 0),e([le()],_e.prototype,"volumeClicked",void 0),customElements.define("sonos-volume",_e);class et extends re{render(){return this.config=this.store.config,this.activePlayer=this.store.activePlayer,G`
      <div class="container">
...
const tt=(e,t,A)=>{for(const A of t)if(A[0]===e)return(0,A[1])();return A?.()};class At{constructor(e,t){this.hass=e,this.currentSection=t}async callMediaService(e,t){Ue(Me,{section:this.currentSection});try{await this.hass.callService("media_player",e,t)}finally{Ue(He)}}async browseMedia(e,t,A){var i;const s=await this.hass.callWS({type:"media_player/browse_media",entity_id:e.id,media_content_id:A,media_content_type:t});return s.children=null===(i=s.children)||void 0===i?void 0:i.map((e=>{var t;return Object.assign(Object.assign({},e),{thumbnail:null===(t=e.thumbnail)||void 0===t?void 0:t.replace("http://","https://")})})),s}async getRelatedEntities(e){return new Promise((async(t,A)=>{const i={type:"render_template",template:"{{ device_entities(device_id('"+e.id+"')) }}"};try{const e=await this.hass.connection.subscribeMessage((A=>{e(),t(A.result.filter((e=>e.includes("switch")||e.includes("number"))).map((e=>this.hass.states[e])))}),i)}catch(e){A(e)}}))}}const it="data:image/png;base64,";function st(e,t){for(const A in e)if(rt(A)===rt(t))return e[A]}function rt(e){return e.replace(/[^a-zA-Z ]/g,"")}function ot(e,t){let A=-1;return e.forEach(((e,i)=>{rt(e)===rt(t)&&(A=i)})),A}function nt(e,t){const A=e.some((e=>e.thumbnail));return e.map((e=>{const i=function(e,t,A){var i,s;let r=null!==(i=st(t.customThumbnail,e.title))&&void 0!==i?i:e.thumbnail;return r?(null==r?void 0:r.match(/https:\/\/brands\.home-assistant\.io\/.+\/logo.png/))&&(r=null==r?void 0:r.replace("logo.png","icon.png")):(r=st(t.customThumbnailIfMissing,e.title),A&&!r&&(r=(null===(s=t.customThumbnailIfMissing)||void 0===s?void 0:s.default)||it)),r||""}(e,t,A);return Object.assign(Object.assign({},e),{thumbnail:i})}))}function at(e,t){return G`
  ...
  `}class ct{constructor(e){this.hassService=e}async getAllFavorites(e,t){if(!e.length)return[];let A=(await Promise.all(e.map((e=>this.getFavoritesForPlayer(e))))).flatMap((e=>e));return A=this.removeDuplicates(A),A=A.length?A:this.getFavoritesFromStates(e),A.filter((e=>-1===ot(null!=t?t:[],e.title)))}removeDuplicates(e){return e.filter(((e,t,A)=>t===A.findIndex((t=>t.title===e.title))))}async getFavoritesForPlayer(e){var t;try{const A=null===(t=(await this.hassService.browseMedia(e,"favorites","")).children)||void 0===t?void 0:t.map((t=>this.hassService.browseMedia(e,t.media_content_type,t.media_content_id)));return(A?await Promise.all(A):[]).flatMap((e=>{var t;return null!==(t=e.children)&&void 0!==t?t:[]}))}catch(t){return console.log("Custom Sonos Card: error getting favorites for player "+e.id+": "+JSON.stringify(t)),[]}}getFavoritesFromStates(e){console.log("Custom Sonos Card: found no favorites with thumbnails, trying with titles only");let t=e.map((e=>e.attributes)).flatMap((e=>e.hasOwnProperty("source_list")?e.source_list:[]));return t=[...new Set(t)],t.length||console.log("Custom Sonos Card: No favorites found"),t.map((e=>({title:e})))}}class dt{constructor(e){this.hassService=e}async join(e,t){await this.hassService.callMediaService("join",{entity_id:e,group_members:t})}async joinPredefinedGroup(e,t){const A=t.entities.map((({player:e})=>e.id));await this.join(e.id,A)}async unJoin(e){await this.hassService.callMediaService("unjoin",{entity_id:e})}async createGroup(e,t){let A;for(const i of t)if(e.entities.some((e=>e.player.id===i.id))){if(i.isPlaying())return void await this.modifyExistingGroup(i,e);A=A||i}if(A)await this.modifyExistingGroup(A,e);else{const{player:t}=e.entities[0];Xe(t.id),await this.joinPredefinedGroup(t,e)}}async modifyExistingGroup(e,t){var A;const i=e.members.filter((e=>!t.entities.some((t=>t.player.id===e.id))));(null==i?void 0:i.length)&&await this.unJoin(i.map((e=>e.id))),Xe(e.id),await this.joinPredefinedGroup(e,t);for(const e of t.entities){const i=null!==(A=e.volume)&&void 0!==A?A:t.volume;i&&await this.volumeSet(e.player,i,!1),t.unmuteWhenGrouped&&await this.setVolumeMute(e.player,!1,!1)}t.media&&await this.setSource(t.entities[0].player,t.media)}async volumeDown(e,t=!0){if(await this.hassService.callMediaService("volume_down",{entity_id:e.id}),t)for(const t of e.members)await this.hassService.callMediaService("volume_down",{entity_id:t.id})}async volumeUp(e,t=!0){if(await this.hassService.callMediaService("volume_up",{entity_id:e.id}),t)for(const t of e.members)await this.hassService.callMediaService("volume_up",{entity_id:t.id})}async volumeSet(e,t,A=!0){const i=t/100;if(await this.hassService.callMediaService("volume_set",{entity_id:e.id,volume_level:i}),A)for(const t of e.members)await this.hassService.callMediaService("volume_set",{entity_id:t.id,volume_level:i})}async toggleMute(e,t=!0){const A=!e.isMuted(t);await this.setVolumeMute(e,A,t)}async setVolumeMute(e,t,A=!0){if(await this.hassService.callMediaService("volume_mute",{entity_id:e.id,is_volume_muted:t}),A)for(const A of e.members)await this.hassService.callMediaService("volume_mute",{entity_id:A.id,is_volume_muted:t})}async setSource(e,t){await this.hassService.callMediaService("select_source",{source:t,entity_id:e.id})}async playMedia(e,t){await this.hassService.callMediaService("play_media",{entity_id:e.id,media_content_id:t.media_content_id,media_content_type:t.media_content_type})}async seek(e,t){await this.hassService.callMediaService("media_seek",{entity_id:e.id,seek_position:t})}}class Et{constructor(e,t,A){this.id=e.entity_id,this.config=t,this.name=this.getEntityName(e,t),this.state=e.state,this.attributes=e.attributes,this.members=A?this.createGroupMembers(e,A):[]}getPlayer(e){return this.id===e?this:this.getMember(e)}getMember(e){return this.members.find((t=>t.id===e))}hasMember(e){return void 0!==this.getMember(e)}isPlaying(){return"playing"===this.state}isMuted(e){return this.attributes.is_volume_muted||e&&this.members.some((e=>e.isMuted(!0)))}getCurrentTrack(){return`${this.attributes.media_artist||""} - ${this.attributes.media_title||""}`.replace(/^ - | - $/g,"")}getEntityName(e,t){const A=e.attributes.friendly_name||"";return t.entityNameRegexToReplace?A.replace(new RegExp(t.entityNameRegexToReplace,"g"),t.entityNameReplacement||""):A}createGroupMembers(e,t){const A=Ge(e);return t.filter((t=>A.includes(t.entity_id)&&e.entity_id!==t.entity_id)).map((e=>new Et(e,this.config)))}isGrouped(){return this.members.length>0}}class Bt{constructor(e,t,A,i){this.hass=e,this.config=t;const s=this.getMediaPlayerHassEntities(this.hass);this.allGroups=this.createPlayerGroups(s),this.allMediaPlayers=this.allGroups.reduce(((e,t)=>[...e,t,...t.members]),[]).sort(((e,t)=>e.name.localeCompare(t.name))),this.activePlayer=this.determineActivePlayer(i),this.hassService=new At(this.hass,A),this.mediaControlService=new dt(this.hassService),this.mediaBrowseService=new ct(this.hassService),this.predefinedGroups=this.createPredefinedGroups()}createPredefinedGroups(){const e=[];if(this.config.predefinedGroups)for(const t of this.config.predefinedGroups){const A=this.createPredefinedGroup(t);A&&e.push(A)}return e}createPredefinedGroup(e){let t;const A=[];let i=e.entities;e.excludeItemsInEntitiesList&&(i=this.convertExclusionsInPredefinedGroupsToInclusions(i));for(const e of i){const t=this.createPredefinedGroupPlayer(e);t&&A.push(t)}return A.length&&(t=Object.assign(Object.assign({},e),{entities:A})),t}convertExclusionsInPredefinedGroupsToInclusions(e){return this.allMediaPlayers.filter((t=>!e.find((e=>("string"==typeof e?e:e.player)===t.id)))).map((e=>e.id))}createPredefinedGroupPlayer(e){var t;let A,i,s;if("string"==typeof e?A=e:(i=e.volume,A=e.player),"unavailable"!==(null===(t=this.hass.states[A])||void 0===t?void 0:t.state)){const e=this.allMediaPlayers.find((e=>e.id===A));e&&(s={player:e,volume:i})}return s}getMediaPlayerHassEntities(e){const t=[...new Set(this.config.entities)];return Object.values(this.hass.entities).filter((e=>e.entity_id.includes("media_player.")&&"sonos"===e.platform)).map((t=>e.states[t.entity_id])).filter(Ge).filter((e=>{const A=t.includes(e.entity_id);return!t.length||this.config.excludeItemsInEntitiesList!==A})).sort(((e,t)=>e.entity_id.localeCompare(t.entity_id)))}createPlayerGroups(e){return e.filter((t=>this.isMainPlayer(t,e))).map((t=>this.createPlayerGroup(t,e))).filter((e=>void 0!==e))}isMainPlayer(e,t){try{const A=Ge(e).filter((e=>t.some((t=>t.entity_id===e)))),i=(null==A?void 0:A.length)>1,s=i&&A&&A[0]===e.entity_id;return!i||s}catch(t){return console.error("Failed to determine main player",JSON.stringify(e),t),!1}}createPlayerGroup(e,t){try{return new Et(e,this.config,t)}catch(t){return void console.error("Failed to create group",JSON.stringify(e),t)}}determineActivePlayer(e){const t=e||this.config.entityId||this.getActivePlayerFromUrl();return this.allGroups.find((e=>void 0!==e.getPlayer(t)))||this.allGroups.find((e=>e.isPlaying()))||this.allGroups[0]}getActivePlayerFromUrl(){return window.location.href.includes("#")?window.location.href.replace(/.*#/g,""):""}}const{GROUPING:ht,GROUPS:Qt,MEDIA_BROWSER:gt,PLAYER:ut,VOLUMES:vt}=Ee;class pt extends re{render(){return G`
    ...
    `}}var mt,ft;e([le({attribute:!1})],pt.prototype,"config",void 0),e([le()],pt.prototype,"section",void 0),customElements.define("sonos-footer",pt),function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(mt||(mt={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(ft||(ft={}));var Ct;class yt extends re{setConfig(e){this.config=JSON.parse(JSON.stringify(e))}static get styles(){return o`
      ha-svg-icon {
        margin: 5px;
      }
      ha-control-button {
    ...
    `}configChanged(){!function(e,t,A,i){i=i||{},A=null==A?{}:A;var s=new Event(t,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});s.detail=A,e.dispatchEvent(s)}(this,"config-changed",{config:this.config}),this.requestUpdate()}dispatchClose(){return Ue("closed")}}e([le({attribute:!1})],yt.prototype,"config",void 0),e([le({attribute:!1})],yt.prototype,"hass",void 0),e([le({attribute:!1})],yt.prototype,"store",void 0),function(e){e.GENERAL="General",e.ENTITIES="Entities",e.ADVANCED="Advanced",e.ARTWORK="Artwork"}(Ct||(Ct={}));const bt=[{name:"hideGroupCurrentTrack",selector:{boolean:{}}},{name:"dynamicVolumeSlider",selector:{boolean:{}}},{name:"hideBrowseMediaButton",selector:{boolean:{}}},{type:"string",name:"labelWhenNoMediaIsSelected"},{type:"string",name:"labelForTheAllVolumesSlider"},{type:"string",name:"artworkHostname"},{name:"mediaBrowserShowTitleForThumbnailIcons",selector:{boolean:{}}},{type:"string",name:"topFavorites"},{type:"integer",name:"numberOfFavoritesToShow",valueMin:1}];customElements.define("sonos-card-advanced-editor",class extends yt{render(){var e;const t=null!==(e=this.store.config.topFavorites)&&void 0!==e?e:[],A=Object.assign(Object.assign({},this.store.config),{topFavorites:t.join(", ")});return G`
    ...
    `}changed(e){const t=e.detail.value;this.config=Object.assign(Object.assign(Object.assign({},this.config),t),{topFavorites:t.topFavorites.split(/ *, */)}),this.configChanged()}});class It extends yt{render(){return G``}}e([le({type:Number})],It.prototype,"index",void 0),customElements.define("sonos-card-custom-source-editor",It);const wt=[{type:"multi_select",options:{player:"Player","media browser":"Media Browser",groups:"Groups",grouping:"Grouping",volumes:"Volumes"},name:"sections"},{type:"integer",name:"mediaBrowserItemsPerRow",default:1,required:!0,valueMin:1,valueMax:30},{type:"string",name:"title"},{name:"showVolumeUpAndDownButtons",selector:{boolean:{}}},{type:"integer",name:"widthPercentage",default:100,required:!0},{type:"integer",name:"heightPercentage",default:100,required:!0}];customElements.define("sonos-card-general-editor",class extends yt{render(){return G` <sonos-card-editor-form .schema=${wt} .store=${this.store}></sonos-card-editor-form> `}});const Pt=[{type:"string",name:"entityNameRegexToReplace"},{type:"string",name:"entityNameReplacement"},{type:"boolean",name:"excludeItemsInEntitiesList"}],St=[{name:"entityId",help:"Not needed, but forces this player to be the selected one on loading the card (overrides url param etc)",selector:{entity:{multiple:!1,filter:{integration:"sonos",domain:"media_player"}}}},{name:"entities",help:"Not needed, unless you don't want to include all of them",selector:{entity:{multiple:!0,filter:{integration:"sonos",domain:"media_player"}}}}];class Lt extends yt{render(){this.config=this.store.config,this.hass=this.store.hass;const e=this.config.predefinedGroups;return this.editGroup>-1?G`<sonos-card-predefined-group-editor
        ...
        `}}e([ce()],Lt.prototype,"editGroup",void 0),customElements.define("sonos-card-entities-editor",Lt);class Ot extends yt{constructor(){super(...arguments),this.schema=[{type:"string",name:"name",required:!0},{type:"string",name:"media"},{type:"boolean",name:"excludeItemsInEntitiesList"},{name:"entities",selector:{entity:{multiple:!0,filter:{integration:"sonos",domain:"media_player"}}}}]}render(){return this.config=this.store.config,this.hass=this.store.hass,this.predefinedGroup||this.initPredefinedGroup(),G`
    ...
    `}initPredefinedGroup(){var e;const t=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e[this.index||0];if(t){const e=t.entities.map((e=>"string"==typeof e?{player:e}:e));this.predefinedGroup=Object.assign(Object.assign({},t),{entities:e})}else this.predefinedGroup={name:"",media:"",entities:[]}}getPredefinedGroupWithoutVolumes(){return Object.assign(Object.assign({},this.predefinedGroup),{entities:this.predefinedGroup.entities.map((e=>e.player))})}groupChanged(e){const t=e.detail.value,A=t.entities.map((e=>{const t=this.predefinedGroup.entities.find((({player:t})=>t===e));return null!=t?t:{player:e}}));this.predefinedGroup=Object.assign(Object.assign({},t),{entities:A})}volumeChanged(e,t){const A=e.detail.value.volume,i=this.predefinedGroup.entities.map((e=>e.player===t?Object.assign(Object.assign({},e),{volume:A}):e));this.predefinedGroup=Object.assign(Object.assign({},this.predefinedGroup),{entities:i})}savePredefinedGroup(){let e=this.config.predefinedGroups;Array.isArray(e)||(e=[]),e[this.index]?e[this.index]=this.predefinedGroup:e=[...e,this.predefinedGroup],this.config.predefinedGroups=e,this.configChanged(),this.dispatchClose()}deletePredefinedGroup(){var e;this.config.predefinedGroups=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e.filter(((e,t)=>t!==this.index)),this.index=-1,this.configChanged(),this.dispatchClose()}}e([le({type:Number})],Ot.prototype,"index",void 0),e([ce()],Ot.prototype,"predefinedGroup",void 0),customElements.define("sonos-card-predefined-group-editor",Ot);class Vt extends yt{render(){this.config=this.store.config,this.hass=this.store.hass;const e=this.config.mediaArtworkOverrides;return this.editItem>-1?G`<sonos-card-artwork-override-editor
        ...
        `}}e([ce()],Vt.prototype,"editItem",void 0),customElements.define("sonos-card-artwork-overrides-editor",Vt);const Mt={ifMissing:!1};class Ht extends yt{render(){var e;this.config=this.store.config,this.hass=this.store.hass;const t=null===(e=this.config.mediaArtworkOverrides)||void 0===e?void 0:e[this.index||0];return G`
    ...
    `}changed(e,t){const A=e.detail.value;let i=this.config.mediaArtworkOverrides;Array.isArray(i)||(i=[]),i[t]?i[t]=A:i=[...i,A],this.config.mediaArtworkOverrides=i,this.configChanged()}}e([le({type:Number})],Ht.prototype,"index",void 0),customElements.define("sonos-card-artwork-override-editor",Ht);class zt extends yt{render(){return this.config=this.store.config,this.hass=this.store.hass,G`
      <ha-form
      ...
      ></ha-form>
    `}valueChanged(e){const t=e.detail.value;this.config=Object.assign(Object.assign({},this.config),t),this.configChanged()}}function kt({help:e,label:t,name:A}){if(t)return t;let i=A.replace(/([A-Z])/g," $1");return i=i.charAt(0).toUpperCase()+i.slice(1),i+(e?` (${e})`:"")}e([le({attribute:!1})],zt.prototype,"schema",void 0),e([le({attribute:!1})],zt.prototype,"data",void 0),e([le()],zt.prototype,"changed",void 0),customElements.define("sonos-card-editor-form",zt);const{GENERAL:Nt,ENTITIES:Tt,ADVANCED:Xt,ARTWORK:Ut}=Ct;class xt extends yt{constructor(){super(...arguments),this.configArea=Nt}render(){return this.config.sections&&0!==this.config.sections.length||(this.config.sections=[Ee.PLAYER,Ee.VOLUMES,Ee.GROUPS,Ee.GROUPING,Ee.MEDIA_BROWSER]),this.store=new Bt(this.hass,this.config,this.config.sections[0]),G`
      <ha-control-button-group>
        ${[Nt,Tt,Ut,Xt].map((e=>G`
            <ha-control-button
      ...
      ${this.subEditor()}
    `}subEditor(){return tt(this.configArea,[[Nt,()=>G`<sonos-card-general-editor .store=${this.store}></sonos-card-general-editor>`],[Tt,()=>G`<sonos-card-entities-editor .store=${this.store}></sonos-card-entities-editor>`],[Xt,()=>G`<sonos-card-advanced-editor .store=${this.store}></sonos-card-advanced-editor>`],[Ut,()=>G`<sonos-card-artwork-overrides-editor .store=${this.store}></sonos-card-artwork-overrides-editor>`]])}static get styles(){return o`
      ha-control-button[selected] {
        --control-button-background-color: var(--primary-color);
      }
    `}}e([ce()],xt.prototype,"configArea",void 0),customElements.define("sonos-card-editor",xt);const{GROUPING:jt,GROUPS:Gt,MEDIA_BROWSER:Rt,PLAYER:Wt,VOLUMES:Dt}=Ee;class Zt extends re{constructor(){super(...arguments),this.showSectionListener=e=>{const t=e.detail;(!this.config.sections||this.config.sections.indexOf(t)>-1)&&(this.section=t)},this.callMediaStartedListener=e=>{this.showLoader||this.config.sections&&e.detail.section!==this.section||(this.cancelLoader=!1,setTimeout((()=>{this.cancelLoader||(this.showLoader=!0,this.loaderTimestamp=Date.now())}),300))},this.callMediaDoneListener=()=>{this.cancelLoader=!0;const e=Date.now()-this.loaderTimestamp;this.showLoader&&(e<1e3?setTimeout((()=>this.showLoader=!1),1e3-e):this.showLoader=!1)},this.activePlayerListener=e=>{const t=e.detail.entityId;t!==this.activePlayerId&&(this.activePlayerId=t,this.requestUpdate())}}render(){this.createStore();let e=je(this.config.heightPercentage);const t=this.config.sections,A=!t||t.length>1,i=A?e-5:e,s=this.config.title;return e=s?e+2:e,G`
      <ha-card style="${this.haCardStyle(e)}">
        ...
        <div class="content" style="${this.contentStyle(i)}">
          ${tt(this.section,[[Wt,()=>G` <sonos-player .store=${this.store}></sonos-player>`],[Gt,()=>G` <sonos-groups .store=${this.store}></sonos-groups>`],[jt,()=>G`<sonos-grouping .store=${this.store}></sonos-grouping>`],[Rt,()=>G` <sonos-media-browser .store=${this.store}></sonos-media-browser>`],[Dt,()=>G` <sonos-volumes .store=${this.store}></sonos-volumes>`]])}
        </div>
        ${me(A,(()=>G`<sonos-footer style=${this.footerStyle()} .config="${this.config}" .section="${this.section}">
            </sonos-footer>`))}
      </ha-card>
    `}createStore(){this.activePlayerId?this.store=new Bt(this.hass,this.config,this.section,this.activePlayerId):(this.store=new Bt(this.hass,this.config,this.section),this.activePlayerId=this.store.activePlayer.id)}getCardSize(){return 3}static getConfigElement(){return document.createElement("sonos-card-editor")}connectedCallback(){var e;super.connectedCallback(),window.addEventListener(Ve,this.showSectionListener),window.addEventListener(Me,this.callMediaStartedListener),window.addEventListener(He,this.callMediaDoneListener),e=this.activePlayerListener,window.addEventListener(Le,e),Ue(Oe)}disconnectedCallback(){var e;window.removeEventListener(Ve,this.showSectionListener),window.removeEventListener(Me,this.callMediaStartedListener),window.removeEventListener(He,this.callMediaDoneListener),e=this.activePlayerListener,window.removeEventListener(Le,e),super.disconnectedCallback()}haCardStyle(e){const t=je(this.config.widthPercentage);return Ke({color:"var(--secondary-text-color)",height:`${e}rem`,minWidth:"20rem",maxWidth:`${t}rem`})}footerStyle(){return Ke({height:"5rem",paddingBottom:"1rem"})}contentStyle(e){return Ke({overflowY:"auto",height:`${e}rem`})}setConfig(e){const t=JSON.parse(JSON.stringify(e));for(const[e,A]of Object.entries(t))Array.isArray(A)&&0===A.length&&delete t[e];const A=t.sections;this.section=A?A.includes(Wt)?Wt:A.includes(Rt)?Rt:A.includes(Gt)?Gt:A.includes(jt)?jt:Dt:Wt,this.config=t}static get styles(){return o`
      :host {
    ...
    `}}e([le({attribute:!1})],Zt.prototype,"hass",void 0),e([le({attribute:!1})],Zt.prototype,"config",void 0),e([ce()],Zt.prototype,"section",void 0),e([ce()],Zt.prototype,"store",void 0),e([ce()],Zt.prototype,"showLoader",void 0),e([ce()],Zt.prototype,"loaderTimestamp",void 0),e([ce()],Zt.prototype,"cancelLoader",void 0),e([ce()],Zt.prototype,"activePlayerId",void 0);class qt extends re{render(){const e=!!this.icon&&!!this.name||W;return G`
      <ha-control-button>
    ...
    `}}e([le()],qt.prototype,"icon",void 0),e([le()],qt.prototype,"name",void 0),customElements.define("sonos-grouping-button",qt);class Yt extends re{render(){return this.activePlayer=this.store.activePlayer,this.allGroups=this.store.allGroups,this.mediaControlService=this.store.mediaControlService,this.mediaPlayerIds=this.store.allMediaPlayers.map((e=>e.id)),G`
      <div class="buttons">
      ...
      <mwc-list multi class="list">
        ${this.getGroupingItems().map((({icon:e,isSelected:t,player:A,isDisabled:i,isMain:s,name:r})=>G`
            <mwc-list-item
              ?activated="${t}"
              ?disabled="${i}"
    ...
    `}async itemClick(e,t,A){e?(t&&Xe(A.id),await this.mediaControlService.unJoin([A.id])):await this.mediaControlService.join(this.activePlayer.id,[A.id])}getGroupingItems(){return this.store.allMediaPlayers.map((e=>new Jt(e,this.activePlayer)))}renderJoinAllButton(){const e=this.getNotJoinedPlayers();return me(e.length,(()=>G`
      ...
      `,ke]}}e([le({attribute:!1})],Yt.prototype,"store",void 0);class Jt{constructor(e,t){this.isMain=e.id===t.id,this.isSelected=this.isMain||t.hasMember(e.id),this.player=e,this.icon=this.isSelected?"marked":"blank",this.isDisabled=this.isSelected&&!t.isGrouped(),this.name=e.name}}class Kt extends re{constructor(){super(...arguments),this.selected=!1,this.dispatchEntityIdEvent=()=>{if(this.selected){Xe(this.player.id)}}}connectedCallback(){super.connectedCallback(),window.addEventListener(Oe,this.dispatchEntityIdEvent)}disconnectedCallback(){window.removeEventListener(Oe,this.dispatchEntityIdEvent),super.disconnectedCallback()}render(){this.config=this.store.config;const e=this.config.hideGroupCurrentTrack?"":this.player.getCurrentTrack(),t=Te(this.player,this.store.predefinedGroups);this.dispatchEntityIdEvent();const A=this.player.attributes.icon;return G`
      <mwc-list-item
        hasMeta
    ...
    `}handleGroupClicked(){if(!this.selected){this.selected=!0;const e=window.location.href.replace(/#.*/g,"");window.location.replace(`${e}#${this.player.id}`),this.dispatchEntityIdEvent(),Ue(Ve,Ee.PLAYER)}}static get styles(){return o`
      @keyframes sound {
        0% {
          opacity: 0.35;
          height: 0.15rem;
    ...
    `}}e([le({attribute:!1})],Kt.prototype,"store",void 0),e([le({attribute:!1})],Kt.prototype,"player",void 0),e([le({type:Boolean})],Kt.prototype,"selected",void 0),customElements.define("sonos-group",Kt);class Ft extends re{render(){return this.activePlayer=this.store.activePlayer,this.groups=this.store.allGroups,G`
    ...
    `}static get styles(){return ke}}e([le({attribute:!1})],Ft.prototype,"store",void 0);class $t extends re{render(){return this.config=this.store.config,G`
      <mwc-list multi class="list">
        ${nt(this.items,this.config).map(((e,t)=>G`
            ${at(e.thumbnail,t)}
            <mwc-list-item class="button" @click="${()=>Ue(ze,e)}">
              <div class="row">${lt(e)}</div>
            </mwc-list-item>
          `))}
      </mwc-list>
    `}static get styles(){return[o`
      ...
      `,Ne,ke]}}e([le({attribute:!1})],$t.prototype,"store",void 0),e([le({type:Array})],$t.prototype,"items",void 0),customElements.define("sonos-media-browser-list",$t);class _t extends re{render(){return this.config=this.store.config,G`
      <style>
        :host {
      ...
      <div class="icons">
        ${nt(this.items,this.config).map(((e,t)=>G`
            ${at(e.thumbnail,t)}
            <ha-control-button class="button" @click="${()=>Ue(ze,e)}">
              ${lt(e,!e.thumbnail||!!this.config.mediaBrowserShowTitleForThumbnailIcons)}
            </ha-control-button>
          `))}
      </div>
    `}static get styles(){return[Ne,o`
        .icons {
          display: flex;
          flex-wrap: wrap;
        }
      ...
      `]}}e([le({attribute:!1})],_t.prototype,"store",void 0),e([le({attribute:!1})],_t.prototype,"items",void 0),customElements.define("sonos-media-browser-icons",_t);class eA extends re{render(){return G`
    ...
    `}}e([le({attribute:!1})],eA.prototype,"store",void 0),customElements.define("sonos-media-browser-header",eA);
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const tA=(e,t)=>{const A=e._$AN;if(void 0===A)return!1;for(const e of A)e._$AO?.(t,!1),tA(e,t);return!0},AA=e=>{let t,A;do{if(void 0===(t=e._$AM))break;A=t._$AN,A.delete(e),e=t}while(0===A?.size)},iA=e=>{for(let t;t=e._$AM;e=t){let A=t._$AN;if(void 0===A)t._$AN=A=new Set;else if(A.has(e))break;A.add(e),oA(t)}};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function sA(e){void 0!==this._$AN?(AA(this),this._$AM=e,iA(this)):this._$AM=e}function rA(e,t=!1,A=0){const i=this._$AH,s=this._$AN;if(void 0!==s&&0!==s.size)if(t)if(Array.isArray(i))for(let e=A;e<i.length;e++)tA(i[e],!1),AA(i[e]);else null!=i&&(tA(i,!1),AA(i));else tA(this,e)}const oA=e=>{e.type==De&&(e._$AP??=rA,e._$AQ??=sA)};class nA extends qe{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,A){super._$AT(e,t,A),iA(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(tA(this,e),AA(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class aA{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}}class lA{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((e=>this.Z=e))}resume(){this.Z?.(),this.Y=this.Z=void 0}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const cA=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,dA=1073741823;const EA=Ze(class extends nA{constructor(){super(...arguments),this._$C_t=dA,this._$Cwt=[],this._$Cq=new aA(this),this._$CK=new lA}render(...e){return e.find((e=>!cA(e)))??R}update(e,t){const A=this._$Cwt;let i=A.length;this._$Cwt=t;const s=this._$Cq,r=this._$CK;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$C_t);e++){const o=t[e];if(!cA(o))return this._$C_t=e,o;e<i&&o===A[e]||(this._$C_t=dA,i=0,Promise.resolve(o).then((async e=>{for(;r.get();)await r.get();const t=s.deref();if(void 0!==t){const A=t._$Cwt.indexOf(o);A>-1&&A<t._$C_t&&(t._$C_t=A,t.setValue(e))}})))}return R}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}});class BA extends re{constructor(){super(...arguments),this.onMediaItemSelected=e=>{const t=e.detail;this.playItem(t),setTimeout((()=>Ue(Ve,Ee.PLAYER)),1e3)}}connectedCallback(){super.connectedCallback(),window.addEventListener(ze,this.onMediaItemSelected)}disconnectedCallback(){window.removeEventListener(ze,this.onMediaItemSelected),super.disconnectedCallback()}render(){return this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaBrowseService=this.store.mediaBrowseService,this.mediaPlayers=this.store.allMediaPlayers,this.mediaControlService=this.store.mediaControlService,G`
      <sonos-media-browser-header .store=${this.store}></sonos-media-browser-header>

      ${this.activePlayer&&EA(this.getAllFavorites().then((e=>this.config.mediaBrowserItemsPerRow>1?G`<sonos-media-browser-icons .items=${e} .store=${this.store}></sonos-media-browser-icons>`:G` <sonos-media-browser-list .items=${e} .store=${this.store}></sonos-media-browser-list>`)))}
    `}async playItem(e){e.media_content_type||e.media_content_id?await this.mediaControlService.playMedia(this.activePlayer,e):await this.mediaControlService.setSource(this.activePlayer,e.title)}async getAllFavorites(){var e,t,A,i;let s=await this.mediaBrowseService.getAllFavorites(this.mediaPlayers,this.config.mediaBrowserTitlesToIgnore);return s.sort(((e,t)=>this.sortOnTopFavoritesThenAlphabetically(e.title,t.title))),s=[...(null===(t=null===(e=this.config.customSources)||void 0===e?void 0:e[this.activePlayer.id])||void 0===t?void 0:t.map(BA.createSource))||[],...(null===(i=null===(A=this.config.customSources)||void 0===A?void 0:A.all)||void 0===i?void 0:i.map(BA.createSource))||[],...s],this.config.numberOfFavoritesToShow?s.slice(0,this.config.numberOfFavoritesToShow):s}sortOnTopFavoritesThenAlphabetically(e,t){var A;const i=null!==(A=this.config.topFavorites)&&void 0!==A?A:[],s=ot(i,e),r=ot(i,t);if(s>-1&&r>-1)return s-r;{let A=r-s;return 0===A&&(A=e.localeCompare(t,"en",{sensitivity:"base"})),A}}static createSource(e){return Object.assign(Object.assign({},e),{can_play:!0})}}e([le({attribute:!1})],BA.prototype,"store",void 0);const{SELECT_SOURCE:hA}=Be;class QA extends re{constructor(){super(...arguments),this.showSwitches={}}render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.hassService=this.store.hassService,this.mediaControlService=this.store.mediaControlService;const e=this.activePlayer.members;return G`
    ...
    `}volumeWithName(e,t=!0){const A=t?this.config.labelForTheAllVolumesSlider?this.config.labelForTheAllVolumesSlider:"All":e.name,i=this.config.showVolumeUpAndDownButtons&&W,s=t||!this.showSwitches[e.id];return G` <div class="row">
      ...
      <div class="switches">
        ...
        ${EA(this.getAdditionalControls(s,e))}
      </div>
