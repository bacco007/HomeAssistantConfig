 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const ue=he(class extends ge{constructor(e){var A;if(super(e),e.type!==Ee||"style"!==e.name||(null===(A=e.strings)||void 0===A?void 0:A.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((A,t)=>{const i=e[t];return null==i?A:A+`${t=t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(e,[A]){const{style:t}=e.element;if(void 0===this.vt){this.vt=new Set;for(const e in A)this.vt.add(e);return this.render(A)}this.vt.forEach((e=>{null==A[e]&&(this.vt.delete(e),e.includes("-")?t.removeProperty(e):t[e]="")}));for(const e in A){const i=A[e];null!=i&&(this.vt.add(e),e.includes("-")?t.setProperty(e,i):t[e]=i)}return x}});function ve(e,A,t){return k`<ha-icon-button
    @click="${A}"
    .path=${e}
    style="${ue(Object.assign({"--mdc-icon-button-size":(null==t?void 0:t.big)?"6rem":"3rem","--mdc-icon-size":(null==t?void 0:t.big)?"6rem":"2rem"},null==t?void 0:t.additionalStyle))}"
...
const Re=(e,A,t)=>{for(const t of A)if(t[0]===e)return(0,t[1])();return null==t?void 0:t()};class Te{constructor(e,A){this.hass=e,this.sectionOnCreate=A}async callMediaService(e,A){window.dispatchEvent(new CustomEvent(be,{bubbles:!0,composed:!0,detail:{section:this.sectionOnCreate}}));try{await this.hass.callService("media_player",e,A)}finally{window.dispatchEvent(new CustomEvent(we,{bubbles:!0,composed:!0}))}}async browseMedia(e,A,t){return await this.hass.callWS({type:"media_player/browse_media",entity_id:e.id,media_content_id:t,media_content_type:A})}async getRelatedSwitchEntities(e){return new Promise((async(A,t)=>{const i={type:"render_template",template:"{{ device_entities(device_id('"+e.id+"')) }}"};try{const e=await this.hass.connection.subscribeMessage((t=>{e(),A(t.result.filter((e=>e.indexOf("switch")>-1)).map((e=>this.hass.states[e])))}),i)}catch(e){t(e)}}))}async toggle(e){await this.hass.callService("homeassistant","toggle",{entity_id:e.entity_id})}}const Ze="data:image/png;base64,";function qe(e,A){for(const t in e)if(Je(t)===Je(A))return e[t]}function Je(e){return e.replace(/[^a-zA-Z ]/g,"")}function Ye(e,A){let t=-1;return e.forEach(((e,i)=>{Je(e)===Je(A)&&(t=i)})),t}function Ke(e,A){const t=e.some((e=>e.thumbnail));return e.map((e=>{const i=function(e,A,t){var i,s;let r=null!==(i=qe(A.customThumbnail,e.title))&&void 0!==i?i:e.thumbnail;return r?(null==r?void 0:r.match(/https:\/\/brands\.home-assistant\.io\/.+\/logo.png/))&&(r=null==r?void 0:r.replace("logo.png","icon.png")):(r=qe(A.customThumbnailIfMissing,e.title),t&&!r&&(r=(null===(s=A.customThumbnailIfMissing)||void 0===s?void 0:s.default)||Ze)),r||""}(e,A,t);return Object.assign(Object.assign({},e),{thumbnail:i,showFolderIcon:e.can_expand&&!i})}))}function Fe(e,A){return k`
  ...
  `}function _e(e=[],A){return null==A?void 0:A.filter((A=>-1===["media-source://tts","media-source://camera"].indexOf(A.media_content_id||"")&&-1===Ye(e,A.title)))}class eA{constructor(e){this.hassService=e}async getRoot(e,A){return _e(A,(await this.hassService.browseMedia(e)).children)||[]}async getDir(e,A,t){try{return _e(t,(await this.hassService.browseMedia(e,A.media_content_type,A.media_content_id)).children)||[]}catch(e){return console.error(e),[]}}async getAllFavorites(e,A){if(!e.length)return[];let t=(await Promise.all(e.map((e=>this.getFavoritesForPlayer(e,A))))).flatMap((e=>e));return t=this.removeDuplicates(t),t.length?t:this.getFavoritesFromStates(e)}removeDuplicates(e){return e.filter(((e,A,t)=>A===t.findIndex((A=>A.title===e.title))))}async getFavoritesForPlayer(e,A){var t;const i=null===(t=(await this.hassService.browseMedia(e,"favorites","")).children)||void 0===t?void 0:t.map((A=>this.hassService.browseMedia(e,A.media_content_type,A.media_content_id)));return(i?await Promise.all(i):[]).flatMap((e=>_e(A,e.children)||[]))}getFavoritesFromStates(e){console.log("Custom Sonos Card: found no favorites with thumbnails, trying with titles only");let A=e.map((e=>e.attributes)).flatMap((e=>e.hasOwnProperty("source_list")?e.source_list:[]));return A=[...new Set(A)],A.length||console.log("Custom Sonos Card: No favorites found"),A.map((e=>({title:e})))}}class AA{constructor(e){this.hassService=e}async join(e,A){await this.hassService.callMediaService("join",{entity_id:e,group_members:A})}async joinPredefinedGroup(e,A){const t=A.entities.map((({player:e})=>e.id));await this.join(e.id,t)}async unJoin(e){await this.hassService.callMediaService("unjoin",{entity_id:e})}async createGroup(e,A){let t;for(const i of A)if(e.entities.some((e=>e.player.id===i.id))){if(i.isPlaying())return void await this.modifyExistingGroup(i,e);t=t||i}if(t)await this.modifyExistingGroup(t,e);else{const{player:A}=e.entities[0];ze(A.id),await this.joinPredefinedGroup(A,e)}}async modifyExistingGroup(e,A){const t=e.members.filter((e=>!A.entities.some((A=>A.player.id===e.id))));(null==t?void 0:t.length)&&await this.unJoin(t.map((e=>e.id))),ze(e.id),await this.joinPredefinedGroup(e,A);for(const e of A.entities)null!=e.volume&&await this.volumeSet(e.player,e.volume,!1);A.media&&await this.setSource(A.entities[0].player,A.media)}async pause(e){await this.hassService.callMediaService("media_pause",{entity_id:e.id})}async prev(e){await this.hassService.callMediaService("media_previous_track",{entity_id:e.id})}async next(e){await this.hassService.callMediaService("media_next_track",{entity_id:e.id})}async play(e){await this.hassService.callMediaService("media_play",{entity_id:e.id})}async shuffle(e){await this.hassService.callMediaService("shuffle_set",{entity_id:e.id,shuffle:!e.attributes.shuffle})}async repeat(e){const A=e.attributes.repeat,t="all"===A?"one":"one"===A?"off":"all";await this.hassService.callMediaService("repeat_set",{entity_id:e.id,repeat:t})}async volumeDown(e,A=!0){if(await this.hassService.callMediaService("volume_down",{entity_id:e.id}),A)for(const A of e.members)await this.hassService.callMediaService("volume_down",{entity_id:A.id})}async volumeUp(e,A=!0){if(await this.hassService.callMediaService("volume_up",{entity_id:e.id}),A)for(const A of e.members)await this.hassService.callMediaService("volume_up",{entity_id:A.id})}async volumeSet(e,A,t=!0){const i=A/100;if(await this.hassService.callMediaService("volume_set",{entity_id:e.id,volume_level:i}),t)for(const A of e.members)await this.hassService.callMediaService("volume_set",{entity_id:A.id,volume_level:i})}async volumeMute(e,A=!0){const t=!e.isMuted();if(await this.hassService.callMediaService("volume_mute",{entity_id:e.id,is_volume_muted:t}),A)for(const A of e.members)await this.hassService.callMediaService("volume_mute",{entity_id:A.id,is_volume_muted:t})}async setSource(e,A){await this.hassService.callMediaService("select_source",{source:A,entity_id:e.id})}async playMedia(e,A){await this.hassService.callMediaService("play_media",{entity_id:e.id,media_content_id:A.media_content_id,media_content_type:A.media_content_type})}}class tA{constructor(e,A,t){this.id=e.entity_id,this.config=A,this.name=this.getEntityName(e,A),this.state=e.state,this.attributes=e.attributes,this.members=t?this.createGroupMembers(e,t):[]}hasPlayer(e){return void 0!==this.getPlayer(e)}getPlayer(e){return this.id===e?this:this.getMember(e)}getMember(e){return this.members.find((A=>A.id===e))}hasMember(e){return void 0!==this.getMember(e)}isPlaying(){return"playing"===this.state}isMuted(){return this.attributes.is_volume_muted||this.members.some((e=>e.isMuted()))}getCurrentTrack(){return`${this.attributes.media_artist||""} - ${this.attributes.media_title||""}`.replace(/^ - /g,"")}getEntityName(e,A){const t=e.attributes.friendly_name||"";return A.entityNameRegexToReplace?t.replace(new RegExp(A.entityNameRegexToReplace,"g"),A.entityNameReplacement||""):t}createGroupMembers(e,A){const t=Xe(e);return A.filter((A=>t.indexOf(A.entity_id)>-1&&e.entity_id!==A.entity_id)).map((e=>new tA(e,this.config)))}isGrouped(){return this.members.length>0}}class iA{constructor(e,A,t){var i;this.hass=e,this.config=A;const s=this.getMediaPlayerHassEntities(this.hass);this.allGroups=this.createPlayerGroups(s),this.allMediaPlayers=this.allGroups.reduce(((e,A)=>[...e,A,...A.members]),[]).sort(((e,A)=>e.name.localeCompare(A.name))),this.activePlayer=this.determineActivePlayer(t);const r=null===(i=this.config.sections)||void 0===i?void 0:i[0];this.hassService=new Te(this.hass,r),this.mediaControlService=new AA(this.hassService),this.mediaBrowseService=new eA(this.hassService),this.predefinedGroups=this.createPredefinedGroups()}createPredefinedGroups(){const e=[];if(this.config.predefinedGroups)for(const A of this.config.predefinedGroups){const t=this.createPredefinedGroup(A);t&&e.push(t)}return e}createPredefinedGroup(e){let A;const t=[];for(const A of e.entities){const e=this.createPredefinedGroupPlayer(A);e&&t.push(e)}return t.length&&(A={name:e.name,entities:t,media:e.media}),A}createPredefinedGroupPlayer(e){var A;let t,i,s;if("string"==typeof e?t=e:(i=e.volume,t=e.player),"unavailable"!==(null===(A=this.hass.states[t])||void 0===A?void 0:A.state)){const e=this.allMediaPlayers.find((e=>e.id===t));e&&(s={player:e,volume:i})}return s}getMediaPlayerHassEntities(e){return this.config.entities?[...new Set(this.config.entities)].map((A=>e.states[A])).filter((e=>void 0!==e)):Object.values(e.states).filter(Xe).sort(((e,A)=>e.entity_id.localeCompare(A.entity_id)))}createPlayerGroups(e){return e.filter((A=>this.isMainPlayer(A,e))).map((A=>this.createPlayerGroup(A,e))).filter((e=>void 0!==e))}isMainPlayer(e,A){try{const t=Xe(e).filter((e=>A.some((A=>A.entity_id===e)))),i=(null==t?void 0:t.length)>1,s=i&&t&&t[0]===e.entity_id;return!i||s}catch(A){return console.error("Failed to determine main player",JSON.stringify(e),A),!1}}createPlayerGroup(e,A){try{return new tA(e,this.config,A)}catch(A){return void console.error("Failed to create group",JSON.stringify(e),A)}}determineActivePlayer(e){const A=e||this.config.entityId||this.getActivePlayerFromUrl();return this.allGroups.find((e=>void 0!==e.getPlayer(A)))||this.allGroups.find((e=>e.isPlaying()))||this.allGroups[0]}getActivePlayerFromUrl(){return window.location.href.indexOf("#")>0?window.location.href.replace(/.*#/g,""):""}}var sA;!function(e){e.MEDIA_BROWSER="media browser",e.GROUPS="groups",e.PLAYER="player",e.GROUPING="grouping",e.VOLUMES="volumes"}(sA||(sA={}));const{GROUPING:rA,GROUPS:oA,MEDIA_BROWSER:nA,PLAYER:aA,VOLUMES:lA}=sA;class cA extends ee{render(){return k`
    ...
    `}configChanged(){!function(e,A,t,i){i=i||{},t=null==t?{}:t;var s=new Event(A,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});s.detail=t,e.dispatchEvent(s)}(this,"config-changed",{config:this.config}),this.requestUpdate()}dispatchClose(){return this.dispatchEvent(new CustomEvent("closed"))}}e([ie()],QA.prototype,"config",void 0),e([ie()],QA.prototype,"hass",void 0),e([ie()],QA.prototype,"store",void 0),function(e){e.GENERAL="General",e.ENTITIES="Entities",e.ADVANCED="Advanced",e.ARTWORK="Artwork"}(EA||(EA={}));const hA=[{name:"hideGroupCurrentTrack",selector:{boolean:{}}},{name:"dynamicVolumeSlider",selector:{boolean:{}}},{type:"string",name:"labelWhenNoMediaIsSelected"},{type:"string",name:"labelForTheAllVolumesSlider"},{type:"string",name:"artworkHostname"},{name:"mediaBrowserShowTitleForThumbnailIcons",selector:{boolean:{}}},{type:"string",name:"topFavorites"}];customElements.define("sonos-card-advanced-editor",class extends QA{render(){var e;const A=null!==(e=this.store.config.topFavorites)&&void 0!==e?e:[],t=Object.assign(Object.assign({},this.store.config),{topFavorites:A.join(", ")});return k`
      <sonos-card-editor-form .schema=${hA} .store=${this.store} .data=${t} .changed=${this.changed}></sonos-card-editor-form>
      <p>
    ...
    `}changed(e){const A=e.detail.value;this.config=Object.assign(Object.assign(Object.assign({},this.config),A),{topFavorites:A.topFavorites.split(/ *, */)}),this.configChanged()}});class gA extends QA{render(){return k``}}e([ie()],gA.prototype,"index",void 0),customElements.define("sonos-card-custom-source-editor",gA);const uA=[{type:"multi_select",options:{player:"Player","media browser":"Media Browser",groups:"Groups",grouping:"Grouping",volumes:"Volumes"},name:"sections"},{type:"integer",name:"mediaBrowserItemsPerRow",default:1,required:!0,valueMin:1,valueMax:30},{type:"string",name:"title"},{name:"showVolumeUpAndDownButtons",selector:{boolean:{}}},{type:"integer",name:"widthPercentage",default:100,required:!0},{type:"integer",name:"heightPercentage",default:100,required:!0}];customElements.define("sonos-card-general-editor",class extends QA{render(){return k` <sonos-card-editor-form .schema=${uA} .store=${this.store}></sonos-card-editor-form> `}});const vA=[{type:"string",name:"entityNameRegexToReplace"},{type:"string",name:"entityNameReplacement"}],pA=[{name:"entityId",help:"Not needed, but forces this player to be the selected one on loading the card (overrides url param etc)",selector:{entity:{multiple:!1,filter:{integration:"sonos",domain:"media_player"}}}},{name:"entities",help:"Not needed, unless you don't want to include all of them",selector:{entity:{multiple:!0,filter:{integration:"sonos",domain:"media_player"}}}}];class mA extends QA{render(){this.config=this.store.config,this.hass=this.store.hass;const e=this.config.predefinedGroups;return this.editGroup>-1?k`<sonos-card-predefined-group-editor
          .index=${this.editGroup}
          .store=${this.store}
          @closed=${()=>this.editGroup=-1}
        ></sonos-card-predefined-group-editor>`:k`
          <sonos-card-editor-form .schema=${pA} .store=${this.store}></sonos-card-editor-form>
          <div>
            Predefined Groups
            <ha-control-button-group>
        ...
        `}}e([se()],mA.prototype,"editGroup",void 0),customElements.define("sonos-card-entities-editor",mA);class CA extends QA{constructor(){super(...arguments),this.schema=[{type:"string",name:"name",required:!0},{type:"string",name:"media"},{name:"entities",selector:{entity:{multiple:!0,filter:{integration:"sonos",domain:"media_player"}}}}]}render(){return this.config=this.store.config,this.hass=this.store.hass,this.predefinedGroup||this.initPredefinedGroup(),k`
    ...
    `}initPredefinedGroup(){var e;const A=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e[this.index||0];if(A){const e=A.entities.map((e=>"string"==typeof e?{player:e}:e));this.predefinedGroup=Object.assign(Object.assign({},A),{entities:e})}else this.predefinedGroup={name:"",media:"",entities:[]}}getPredefinedGroupWithoutVolumes(){return Object.assign(Object.assign({},this.predefinedGroup),{entities:this.predefinedGroup.entities.map((e=>e.player))})}groupChanged(e){const A=e.detail.value,t=A.entities.map((e=>{const A=this.predefinedGroup.entities.find((({player:A})=>A===e));return null!=A?A:{player:e}}));this.predefinedGroup=Object.assign(Object.assign({},A),{entities:t})}volumeChanged(e,A){const t=e.detail.value.volume,i=this.predefinedGroup.entities.map((e=>e.player===A?Object.assign(Object.assign({},e),{volume:t}):e));this.predefinedGroup=Object.assign(Object.assign({},this.predefinedGroup),{entities:i})}savePredefinedGroup(){let e=this.config.predefinedGroups;Array.isArray(e)||(e=[]),e[this.index]?e[this.index]=this.predefinedGroup:e=[...e,this.predefinedGroup],this.config.predefinedGroups=e,this.configChanged(),this.dispatchClose()}deletePredefinedGroup(){var e;this.config.predefinedGroups=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e.filter(((e,A)=>A!==this.index)),this.index=-1,this.configChanged(),this.dispatchClose()}}e([ie()],CA.prototype,"index",void 0),e([se()],CA.prototype,"predefinedGroup",void 0),customElements.define("sonos-card-predefined-group-editor",CA);class fA extends QA{render(){this.config=this.store.config,this.hass=this.store.hass;const e=this.config.mediaArtworkOverrides;return this.editItem>-1?k`<sonos-card-artwork-override-editor
        ...
        `}}e([se()],fA.prototype,"editItem",void 0),customElements.define("sonos-card-artwork-overrides-editor",fA);const yA={ifMissing:!1};class bA extends QA{render(){var e;this.config=this.store.config,this.hass=this.store.hass;const A=null===(e=this.config.mediaArtworkOverrides)||void 0===e?void 0:e[this.index||0];return k`
    ...
    `}changed(e,A){const t=e.detail.value;let i=this.config.mediaArtworkOverrides;Array.isArray(i)||(i=[]),i[A]?i[A]=t:i=[...i,t],this.config.mediaArtworkOverrides=i,this.configChanged()}}e([ie()],bA.prototype,"index",void 0),customElements.define("sonos-card-artwork-override-editor",bA);class wA extends QA{render(){return this.config=this.store.config,this.hass=this.store.hass,k`
      <ha-form
      ...
      ></ha-form>
    `}valueChanged(e){const A=e.detail.value;this.config=Object.assign(Object.assign({},this.config),A),this.configChanged()}}function IA({help:e,label:A,name:t}){if(A)return A;let i=t.replace(/([A-Z])/g," $1");return i=i.charAt(0).toUpperCase()+i.slice(1),i+(e?` (${e})`:"")}e([ie()],wA.prototype,"schema",void 0),e([ie()],wA.prototype,"data",void 0),e([ie()],wA.prototype,"changed",void 0),customElements.define("sonos-card-editor-form",wA);const{GENERAL:PA,ENTITIES:LA,ADVANCED:VA,ARTWORK:SA}=EA;class HA extends QA{constructor(){super(...arguments),this.configArea=PA}render(){return this.store=new iA(this.hass,this.config),this.config.sections&&0!==this.config.sections.length||(this.config.sections=[sA.PLAYER,sA.VOLUMES,sA.GROUPS,sA.GROUPING,sA.MEDIA_BROWSER]),k`
      <ha-control-button-group>
        ${[PA,LA,SA,VA].map((e=>k`
            <ha-control-button
      ...
      ${this.subEditor()}
    `}subEditor(){return Re(this.configArea,[[PA,()=>k`<sonos-card-general-editor .store=${this.store}></sonos-card-general-editor>`],[LA,()=>k`<sonos-card-entities-editor .store=${this.store}></sonos-card-entities-editor>`],[VA,()=>k`<sonos-card-advanced-editor .store=${this.store}></sonos-card-advanced-editor>`],[SA,()=>k`<sonos-card-artwork-overrides-editor .store=${this.store}></sonos-card-artwork-overrides-editor>`]])}configAreaStyle(e){return this.configArea===e?ue({"--control-button-background-color":"var(--primary-color)"}):""}}
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
function MA(e,A,t){return e?A():null==t?void 0:t()}e([se()],HA.prototype,"configArea",void 0),customElements.define("sonos-card-editor",HA);const{GROUPING:OA,GROUPS:zA,MEDIA_BROWSER:kA,PLAYER:xA,VOLUMES:NA}=sA;class XA extends ee{constructor(){super(...arguments),this.showSectionListener=e=>{const A=e.detail;(!this.config.sections||this.config.sections.indexOf(A)>-1)&&(this.section=A)},this.callMediaStartedListener=e=>{this.showLoader||this.config.sections&&e.detail.section!==this.section||(this.cancelLoader=!1,setTimeout((()=>{this.cancelLoader||(this.showLoader=!0,this.loaderTimestamp=Date.now())}),300))},this.callMediaDoneListener=()=>{this.cancelLoader=!0;const e=Date.now()-this.loaderTimestamp;this.showLoader&&(e<1e3?setTimeout((()=>this.showLoader=!1),1e3-e):this.showLoader=!1)},this.activePlayerListener=e=>{const A=e.detail.entityId;A!==this.activePlayerId&&(this.activePlayerId=A,this.requestUpdate())}}render(){this.createStore();let e=Ne(this.config.heightPercentage);const A=this.config.sections,t=!A||A.length>1,i=t?e-5:e,s=this.config.title;return e=s?e+2:e,k`
      <ha-card style="${this.haCardStyle(e)}">
        ...
        <div class="content" style="${this.contentStyle(i)}">
          ${Re(this.section,[[xA,()=>k` <sonos-player .store=${this.store}></sonos-player>`],[zA,()=>k` <sonos-groups .store=${this.store}></sonos-groups>`],[OA,()=>k`<sonos-grouping .store=${this.store}></sonos-grouping>`],[kA,()=>k` <sonos-media-browser .store=${this.store}></sonos-media-browser>`],[NA,()=>k` <sonos-volumes .store=${this.store}></sonos-volumes>`]])}
        </div>
        ${MA(t,(()=>k`<sonos-footer style=${this.footerStyle()} .config="${this.config}" .section="${this.section}">
            </sonos-footer>`))}
      </ha-card>
    `}createStore(){this.activePlayerId?this.store=new iA(this.hass,this.config,this.activePlayerId):(this.store=new iA(this.hass,this.config),this.activePlayerId=this.store.activePlayer.id)}getCardSize(){return 3}static getConfigElement(){return document.createElement("sonos-card-editor")}connectedCallback(){super.connectedCallback(),window.addEventListener(ye,this.showSectionListener),window.addEventListener(be,this.callMediaStartedListener),window.addEventListener(we,this.callMediaDoneListener),function(e){window.addEventListener(Ce,e);const A=new CustomEvent(fe,{bubbles:!0,composed:!0});window.dispatchEvent(A)}(this.activePlayerListener)}disconnectedCallback(){var e;window.removeEventListener(ye,this.showSectionListener),window.removeEventListener(be,this.callMediaStartedListener),window.removeEventListener(we,this.callMediaDoneListener),e=this.activePlayerListener,window.removeEventListener(Ce,e),super.disconnectedCallback()}haCardStyle(e){const A=Ne(this.config.widthPercentage);return ue({color:"var(--secondary-text-color)",height:`${e}rem`,minWidth:"20rem",maxWidth:`${A}rem`})}footerStyle(){return ue({height:"5rem",paddingBottom:"1rem"})}contentStyle(e){return ue({overflowY:"auto",height:`${e}rem`})}setConfig(e){const A=JSON.parse(JSON.stringify(e));for(const[e,t]of Object.entries(A))Array.isArray(t)&&0===t.length&&delete A[e];const t=A.sections;this.section=t?t.indexOf(xA)>-1?xA:t.indexOf(kA)>-1?kA:t.indexOf(zA)>-1?zA:t.indexOf(OA)>-1?OA:NA:xA,this.config=A}static get styles(){return o`
      .loader {
        position: absolute;
        z-index: 1000;
        top: 50%;
    ...
    <ha-control-button @click="${e}" style=${ue({width:"fit-content","--control-button-background-color":"var(--accent-color)","--control-button-icon-color":"var(--secondary-text-color)"})}>
      <ha-icon .icon=${A} style=${ue({padding:"1rem"})}></ha-icon>
      ${t?k`<span style=${ue({paddingRight:"1rem",fontWeight:"bold"})}>${t}</span>`:""}
    </ha-control-button>
  `}e([ie({attribute:!1})],XA.prototype,"hass",void 0),e([ie()],XA.prototype,"config",void 0),e([se()],XA.prototype,"section",void 0),e([se()],XA.prototype,"store",void 0),e([se()],XA.prototype,"showLoader",void 0),e([se()],XA.prototype,"loaderTimestamp",void 0),e([se()],XA.prototype,"cancelLoader",void 0),e([se()],XA.prototype,"activePlayerId",void 0);class GA extends ee{render(){return this.activePlayer=this.store.activePlayer,this.allGroups=this.store.allGroups,this.mediaControlService=this.store.mediaControlService,this.mediaPlayerIds=this.store.allMediaPlayers.map((e=>e.id)),k`
      <div class="buttons">
        ${this.renderJoinAllButton()} ${this.renderUnJoinAllButton()}
        ${MA(this.store.predefinedGroups,(()=>this.renderPredefinedGroups()))}
      </div>
    ...
    `}renderJoinAllButton(){const e=this.getNotJoinedPlayers();return MA(e.length,(()=>jA((async()=>await this.mediaControlService.join(this.activePlayer.id,e)),"mdi:checkbox-multiple-marked-outline","")))}getNotJoinedPlayers(){return this.mediaPlayerIds.filter((e=>e!==this.activePlayer.id&&!this.activePlayer.hasMember(e)))}renderUnJoinAllButton(){const e=this.getJoinedPlayers();return MA(e.length,(()=>jA((async()=>await this.mediaControlService.unJoin(e)),"mdi:minus-box-multiple-outline","")))}getJoinedPlayers(){return this.mediaPlayerIds.filter((e=>e!==this.activePlayer.id&&this.activePlayer.hasMember(e)))}getGroupingItem(e){const A=e.id===this.activePlayer.id;return{isMain:A,isSelected:A||this.activePlayer.hasMember(e.id),isGrouped:this.activePlayer.isGrouped(),player:e}}async itemClickAction({isSelected:e,player:A,isMain:t}){e?(t&&ze(this.activePlayer.id),await this.mediaControlService.unJoin([A.id])):await this.mediaControlService.join(this.activePlayer.id,[A.id])}renderPredefinedGroups(){return this.store.predefinedGroups.map((e=>jA((async()=>await this.mediaControlService.createGroup(e,this.allGroups)),"mdi:speaker-multiple",e.name)))}static get styles(){return[o`
        .buttons {
          margin: 1rem;
          display: flex;
          flex-wrap: wrap;
    ...
    `}handleGroupClicked(){if(!this.selected){this.selected=!0;const e=window.location.href.replace(/#.*/g,"");window.location.replace(`${e}#${this.player.id}`),this.dispatchEntityIdEvent(),Me(sA.PLAYER)}}static get styles(){return o`
      @keyframes sound {
        0% {
          opacity: 0.35;
          height: 0.15rem;
    ...
    `}}e([ie()],UA.prototype,"store",void 0),e([ie()],UA.prototype,"player",void 0),e([ie()],UA.prototype,"selected",void 0),customElements.define("sonos-group",UA);class WA extends ee{render(){return this.activePlayer=this.store.activePlayer,this.groups=this.store.allGroups,k`
    ...
    `}static get styles(){return Se}}e([ie()],WA.prototype,"store",void 0);
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const DA=(e,A)=>{var t,i;const s=e._$AN;if(void 0===s)return!1;for(const e of s)null===(i=(t=e)._$AO)||void 0===i||i.call(t,A,!1),DA(e,A);return!0},RA=e=>{let A,t;do{if(void 0===(A=e._$AM))break;t=A._$AN,t.delete(e),e=A}while(0===(null==t?void 0:t.size))},TA=e=>{for(let A;A=e._$AM;e=A){let t=A._$AN;if(void 0===t)A._$AN=t=new Set;else if(t.has(e))break;t.add(e),JA(A)}};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ZA(e){void 0!==this._$AN?(RA(this),this._$AM=e,TA(this)):this._$AM=e}function qA(e,A=!1,t=0){const i=this._$AH,s=this._$AN;if(void 0!==s&&0!==s.size)if(A)if(Array.isArray(i))for(let e=t;e<i.length;e++)DA(i[e],!1),RA(i[e]);else null!=i&&(DA(i,!1),RA(i));else DA(this,e)}const JA=e=>{var A,t,i,s;e.type==Qe&&(null!==(A=(i=e)._$AP)&&void 0!==A||(i._$AP=qA),null!==(t=(s=e)._$AQ)&&void 0!==t||(s._$AQ=ZA))};class YA extends ge{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,A,t){super._$AT(e,A,t),TA(this),this.isConnected=e._$AU}_$AO(e,A=!0){var t,i;e!==this.isConnected&&(this.isConnected=e,e?null===(t=this.reconnected)||void 0===t||t.call(this):null===(i=this.disconnected)||void 0===i||i.call(this)),A&&(DA(this,e),RA(this))}setValue(e){if((e=>void 0===e.strings)(this._$Ct))this._$Ct._$AI(e,this);else{const A=[...this._$Ct._$AH];A[this._$Ci]=e,this._$Ct._$AI(A,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class KA{constructor(e){this.Y=e}disconnect(){this.Y=void 0}reconnect(e){this.Y=e}deref(){return this.Y}}class FA{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){var e;null!==(e=this.Z)&&void 0!==e||(this.Z=new Promise((e=>this.q=e)))}resume(){var e;null===(e=this.q)||void 0===e||e.call(this),this.Z=this.q=void 0}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $A=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then;const _A=he(class extends YA{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CK=new KA(this),this._$CX=new FA}render(...e){var A;return null!==(A=e.find((e=>!$A(e))))&&void 0!==A?A:x}update(e,A){const t=this._$Cyt;let i=t.length;this._$Cyt=A;const s=this._$CK,r=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<A.length&&!(e>this._$Cwt);e++){const o=A[e];if(!$A(o))return this._$Cwt=e,o;e<i&&o===t[e]||(this._$Cwt=1073741823,i=0,Promise.resolve(o).then((async e=>{for(;r.get();)await r.get();const A=s.deref();if(void 0!==A){const t=A._$Cyt.indexOf(o);t>-1&&t<A._$Cwt&&(A._$Cwt=t,A.setValue(e))}})))}return x}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}});class et extends ee{render(){return this.config=this.store.config,k`
      <mwc-list multi class="list">
        ${Ke(this.items,this.config).map(((e,A)=>k`
            ${Fe(e.thumbnail,A)}
    ...
    `}static get styles(){return[o`
      ...
      `,He,Se]}}e([ie()],et.prototype,"store",void 0),e([ie()],et.prototype,"items",void 0),customElements.define("sonos-media-browser-list",et);class At extends ee{render(){return this.config=this.store.config,k`
      <style>
        :host {
    ...
    `}static get styles(){return[He,o`
      ...
      `]}}e([ie()],At.prototype,"store",void 0),e([ie()],At.prototype,"items",void 0),customElements.define("sonos-media-browser-icons",At);class tt extends ee{constructor(){super(...arguments),this.browseMedia=!0}render(){const e=this.browseMedia?"M4,6H2V20A2,2 0 0,0 4,22H18V20H4V6M20,2H8A2,2 0 0,0 6,4V16A2,2 0 0,0 8,18H20A2,2 0 0,0 22,16V4A2,2 0 0,0 20,2M12,14.5V5.5L18,10L12,14.5Z":this.mediaBrowserDir?"M13.5 21C9.36 21 6 17.64 6 13.5V11H2L8 4L14 11H10V13.5C10 15.43 11.57 17 13.5 17H21V21H13.5Z":ce;return k`
      <div class="play">
    ...
    `}}e([ie()],tt.prototype,"config",void 0),e([se()],tt.prototype,"browseCanPlay",void 0),e([se()],tt.prototype,"browseMedia",void 0),e([se()],tt.prototype,"mediaBrowserDir",void 0),e([se()],tt.prototype,"title",void 0),customElements.define("sonos-media-browser-header",tt);const it="custom-sonos-card_currentDir";class st extends ee{constructor(){super(...arguments),this.parentDirs=[],this.playDirListener=async()=>{await this.playItem(this.currentDir)},this.browseClickedListener=async()=>{this.browseClicked()},this.onMediaItemSelected=e=>{const A=e.detail;A.can_expand?(this.currentDir&&this.parentDirs.push(this.currentDir),this.setCurrentDir(A)):A.can_play&&(this.playItem(A),setTimeout((()=>Me(sA.PLAYER)),1e3))}}connectedCallback(){super.connectedCallback(),window.addEventListener(Ie,this.playDirListener),window.addEventListener(Pe,this.browseClickedListener),window.addEventListener(Ve,this.onMediaItemSelected)}disconnectedCallback(){window.removeEventListener(Ie,this.playDirListener),window.removeEventListener(Pe,this.browseClickedListener),window.removeEventListener(Ve,this.onMediaItemSelected),super.disconnectedCallback()}render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaBrowseService=this.store.mediaBrowseService,this.mediaPlayers=this.store.allMediaPlayers,this.mediaControlService=this.store.mediaControlService;const e=localStorage.getItem(it);if(e){const A=JSON.parse(e);A!==this.currentDir&&(this.currentDir=A,this.browse=!0,this.dispatchBrowseState())}return k`
      <sonos-media-browser-header .config=${this.config}></sonos-media-browser-header>
      ${this.activePlayer&&_A((this.browse?this.loadMediaDir(this.currentDir):this.getAllFavorites()).then((e=>this.config.mediaBrowserItemsPerRow>1?k`<sonos-media-browser-icons .items=${e} .store=${this.store}></sonos-media-browser-icons>`:k` <sonos-media-browser-list .items=${e} .store=${this.store}></sonos-media-browser-list>`)))}
    `}firstUpdated(){this.dispatchBrowseState()}dispatchBrowseState(){var e;const A=this.browse?this.currentDir?this.currentDir.title:"Media Browser":"All Favorites";window.dispatchEvent(new CustomEvent(Le,{detail:{canPlay:null===(e=this.currentDir)||void 0===e?void 0:e.can_play,browse:this.browse,currentDir:this.currentDir,title:A}}))}browseClicked(){this.parentDirs.length?this.setCurrentDir(this.parentDirs.pop()):this.currentDir?this.setCurrentDir(void 0):(this.browse=!this.browse,this.dispatchBrowseState())}setCurrentDir(e){this.currentDir=e,e?localStorage.setItem(it,JSON.stringify(e)):localStorage.removeItem(it),this.dispatchBrowseState()}async playItem(e){e.media_content_type||e.media_content_id?await this.mediaControlService.playMedia(this.activePlayer,e):await this.mediaControlService.setSource(this.activePlayer,e.title)}async getAllFavorites(){var e,A,t,i;let s=await this.mediaBrowseService.getAllFavorites(this.mediaPlayers,this.config.mediaBrowserTitlesToIgnore);return s=s.sort(((e,A)=>{var t;const i=null!==(t=this.config.topFavorites)&&void 0!==t?t:[],s=Ye(i,e.title),r=Ye(i,A.title);if(s>-1&&r>-1)return s-r;{let t=r-s;return 0===t&&(t=e.title.localeCompare(A.title,"en",{sensitivity:"base"})),t}})),[...(null===(A=null===(e=this.config.customSources)||void 0===e?void 0:e[this.activePlayer.id])||void 0===A?void 0:A.map(st.createSource))||[],...(null===(i=null===(t=this.config.customSources)||void 0===t?void 0:t.all)||void 0===i?void 0:i.map(st.createSource))||[],...s]}static createSource(e){return Object.assign(Object.assign({},e),{can_play:!0})}async loadMediaDir(e){return await(e?this.mediaBrowseService.getDir(this.activePlayer,e,this.config.mediaBrowserTitlesToIgnore):this.mediaBrowseService.getRoot(this.activePlayer,this.config.mediaBrowserTitlesToIgnore))}}e([ie()],st.prototype,"store",void 0),e([se()],st.prototype,"browse",void 0),e([se()],st.prototype,"currentDir",void 0);class rt extends ee{constructor(){super(...arguments),this.showSwitches={}}render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.hassService=this.store.hassService,this.mediaControlService=this.store.mediaControlService;const e=this.activePlayer.members;return k`
      ${MA(e.length,(()=>this.volumeWithName(this.activePlayer)))}
    ...
    `}}e([ie()],rt.prototype,"store",void 0),e([se()],rt.prototype,"showSwitches",void 0),customElements.define("sonos-volumes",rt);const ot=e=>"Sonos"+(e?` (${e})`:""),nt=e=>"Media player for your Sonos speakers"+(e?` (${e})`:"");window.customCards.push({type:"sonos-card",name:ot(),description:nt(),preview:!0},{type:"sonos-grouping",name:ot("Grouping section"),description:nt("Grouping section"),preview:!0},{type:"sonos-groups",name:ot("Groups section"),description:nt("Groups section"),preview:!0},{type:"sonos-media-browser",name:ot("Media Browser section"),description:nt("Media Browser section"),preview:!0},{type:"sonos-player",name:ot("Player section"),description:"Media player for your Sonos speakers (Player section)",preview:!0}),customElements.define("sonos-card",XA),customElements.define("sonos-grouping",GA),customElements.define("sonos-groups",WA),customElements.define("sonos-media-browser",st),customElements.define("sonos-player",De);
