      ...
      <div class="main" id="mediaControls">
          <div class="icons">
              ...
              <div class="audio-input-format">
                ${this.config.showAudioInputFormat && m(this.getAudioInputFormat())}
              </div>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const n$1 = "important", i4 = " !" + n$1, o = e(class extends i$2 {
  constructor(t2) {
...
class Grouping extends i$4 {
    ...
    return x`
      <div class="wrapper">
        <div class="predefined-groups">
          ...
          ${n2(this.store.predefinedGroups, () => this.renderPredefinedGroups())}
        </div>
        <div class="list">
  ...
  renderJoinAllButton() {
    ...
    return n2(this.notJoinedPlayers.length, () => this.groupingButton(icon, this.selectAll));
  }
  ...
  renderUnJoinAllButton() {
    ...
    return n2(this.joinedPlayers.length, () => this.groupingButton(icon, this.deSelectAll));
  }
  getJoinedPlayers() {
    return this.mediaPlayerIds.filter(
      (playerId) => playerId === this.activePlayer.id || this.activePlayer.hasMember(playerId)
...
class Volumes extends i$4 {
  ...
  render() {
    ...
    return x`
      ${n2(members.length > 1, () => this.volumeWithName(this.activePlayer))}
...
class HaPlayer extends i$4 {
  render() {
    ...
    return x` <more-info-content .stateObj=${playerState} .hass=${this.store.hass}></more-info-content> `;
  }
}
__decorateClass$2([
  n$4({ attribute: false })
