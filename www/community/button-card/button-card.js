      ...
      if (null !== t) {
        if ((u++, 1 === t.nodeType)) {
          ...
          if (e.indexOf(n) >= 0) {
            ...
            "" === r[a] ? (n.insertBefore(c(), t), i.push(t)) : (t.data = r[a]),
              (d += a);
          }
        } else if (8 === t.nodeType)
          if (t.data === n) {
            const e = t.parentNode;
            (null !== t.previousSibling && u !== l) ||
              (u++, e.insertBefore(c(), t)),
              (l = u),
              this.parts.push({ type: "node", index: u }),
  ...
  getHTML() {
    ...
    for (let s = 0; s < t; s++) {
      ...
      e +=
        null === o
          ? t + (i ? w : r)
          : t.substr(0, o.index) + o[1] + o[2] + "$lit$" + o[3] + n;
    }
...
function $(t) {
  ...
  return (
    (i = e.keyString.get(r)),
    void 0 === i &&
      ((i = new a(t, t.getTemplateElement())), e.keyString.set(r, i)),
...
const V = new (class {
  handleAttributeExpressions(t, e, i, n) {
    ...
    if ("@" === r) return [new N(t, e.slice(1), n.eventContext)];
      ...
      ? (function (t, e, i = null) {
          ...
          for (; s.nextNode(); )
            for (
              l++,
                s.currentNode === i &&
                  ((o = d(e)), i.parentNode.insertBefore(e, i));
              -1 !== a && r[a].index === l;
...
const st = new WeakMap(),
  at = m((t) => (e) => {
    ...
    let r = st.get(e);
    void 0 === r &&
      ((n.cssText = i.strings.join(" ")), st.set(e, (r = new Set()))),
      r.forEach((e) => {
        e in t ||
          (r.delete(e),
    ...
    for (const s in t)
      r.add(s), -1 === s.indexOf("-") ? (n[s] = t[s]) : n.setProperty(s, t[s]);
  }),
  ot = new WeakMap(),
  lt = m((t) => (e) => {
    if (!(e instanceof M))
...
const ht = new WeakMap(),
  ut = m((t) => (e) => {
    ...
    let r = ht.get(e);
    void 0 === r &&
      (n.setAttribute("class", i.strings.join(" ")),
      ht.set(e, (r = new Set())));
...
var bt = [
  ...
  kt = {
    ...
    ZZ: function (t) {
      ...
      return (
        (e > 0 ? "-" : "+") +
        xt(100 * Math.floor(Math.abs(e) / 60) + (Math.abs(e) % 60), 4)
      );
    },
    Z: function (t) {
      var e = t.getTimezoneOffset();
...
var At = function (t, e, i) {
  ...
  var n = [];
  e = (e = Pt[e] || e).replace(ft, function (t, e) {
    return n.push(e), "@@@";
  });
  var r = _t(_t({}, St), i);
...
function Yt(t, e) {
  ...
  switch (t) {
    ...
    default:
      return (
        console.warn("Unable to find icon for domain " + t + " (" + e + ")"), Dt
      );
  }
}
var Bt = function (t) {
    ...
    if (
      ...
      switch (s.action) {
        ...
        case "call-service":
          ...
          break;
        case "fire-dom-event":
          It(t, "ll-custom", s), s.haptic && Bt(s.haptic);
      }
  },
  Zt = {
  ...
  return (
    "string" == typeof t &&
      (t = (function (t) {
        ...
        if ((i = ye.hsl.exec(t))) return { h: i[1], s: i[2], l: i[3] };
        if ((i = ye.hsla.exec(t)))
          return { h: i[1], s: i[2], l: i[3], a: i[4] };
        if ((i = ye.hsv.exec(t))) return { h: i[1], s: i[2], v: i[3] };
        if ((i = ye.hsva.exec(t)))
...
var ge = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",
  ...
  ye = {
    ...
    rgb: new RegExp("rgb" + _e),
    rgba: new RegExp("rgba" + be),
    hsl: new RegExp("hsl" + _e),
    hsla: new RegExp("hsla" + be),
    hsv: new RegExp("hsv" + _e),
...
function ve(t) {
  return Boolean(ye.CSS_UNIT.exec(String(t)));
}
var we = (function () {
  function t(e, i) {
    var n;
  ...
  return (
    ...
    (t.prototype.setAlpha = function (t) {
      return (
        (this.a = se(t)), (this.roundA = Math.round(100 * this.a) / 100), this
      );
    }),
        ...
        (function (t, e, i, n, r) {
          var s,
            a = [
              ...
              oe(Math.round(e).toString(16)),
              oe(Math.round(i).toString(16)),
              oe(((s = n), Math.round(255 * parseFloat(s)).toString(16))),
            ];
          return r &&
    ...
    (t.prototype.toName = function () {
      ...
      for (
        var t = "#" + ue(this.r, this.g, this.b, !1),
          e = 0,
          i = Object.entries(fe);
        e < i.length;
        e++
...
function Se(t, e) {
  return void 0 === t && (t = ""), void 0 === e && (e = {}), new we(t, e);
}
function xe(t) {
  return t.substr(0, t.indexOf("."));
}
  ...
  if (
    ...
    return (function (t, e) {
      ...
      return (
          ...
          : (i =
              ...
              !["unknown", "unavailable"].includes(e.state)
                ...
                ? ["initializing", "dead"].includes(e.state)
                  ? t(
                      "state.zwave.query_stage." + e.state,
                      "query_stage",
        ...
        i ||
          (i =
            t("state.default." + e.state) ||
            t(`component.${n}.state.${e.state}`) ||
            e.state),
        i
      );
    })(e, i);
  if ("unknown" === i.state || "unavailable" === i.state)
    return e("state.default." + i.state);
  if (i.attributes.unit_of_measurement)
    return `${i.state} ${i.attributes.unit_of_measurement}`;
  const r = xe(i.entity_id);
  if ("input_datetime" === r) {
    let t;
...
var Pe = Function.prototype.toString,
  ...
  Le = Ve.propertyIsEnumerable,
  Fe = "function" == typeof He,
  Ie = "function" == typeof WeakMap,
  ze = function (t, e) {
    if (!t.constructor) return Ae(null);
    var i = t.constructor,
      n = t.__proto__ || Re(t);
    if (i === e.Object) return n === e.Object.prototype ? {} : Ae(n);
    if (~Pe.call(i).indexOf("[native code]"))
      try {
        return new i();
      } catch (r) {}
    return Ae(n);
  ...
  Ue = function (t, e, i, n) {
    var r = ze(t, e);
    for (var s in (n.set(t, r), t)) De.call(t, s) && (r[s] = i(t[s], n));
    if (Fe) {
      var a = He(t),
        o = a.length;
      if (o)
        for (var l = 0, c = void 0; l < o; l++)
          (c = a[l]), Le.call(t, c) && (r[c] = i(t[c], n));
    }
    return r;
  },
  qe = function (t, e, i, n) {
  ...
  var i = !(!e || !e.isStrict),
    ...
    s = function (t, e) {
      ...
      if (n.Blob && t instanceof n.Blob)
        return (a = new Blob([t], { type: t.type }));
      ...
      if (n.ArrayBuffer) {
        if (n.ArrayBuffer.isView(t))
          return (a = new c(t.buffer.slice(0))), e.set(t, a), a;
...
We.strict = function (t, e) {
  return We(t, { isStrict: !0, realm: e ? e.realm : void 0 });
};
let Ge = window.cardHelpers;
const Ze = new Promise(async (t) => {
  Ge && t(),
    window.loadCardHelpers &&
      ((Ge = await window.loadCardHelpers()), (window.cardHelpers = Ge), t());
});
console.info(
  "%c  BUTTON-CARD  \n%c Version 3.4.2 ",
...
let Je = class extends nt {
  ...
  _createCard(t) {
    if (Ge) return Ge.createCardElement(t);
    {
  ...
  _calculateRemaining(t) {
    t.attributes.remaining &&
      (this._timeRemaining = (function (t) {
        var e = Nt(t.attributes.remaining);
        if ("active" === t.state) {
          ...
          ? t.attributes.rgb_color
            ? ((i = `rgb(${t.attributes.rgb_color.join(",")})`),
              t.attributes.brightness &&
                (i = Oe(i, (t.attributes.brightness + 245) / 5)))
            : e &&
  ...
  _buildStateString(t) {
    ...
    if (this._config.show_state && t && t.state) {
      ...
      n
        ? (i = `${t.state} ${n}`)
        : "timer" === xe(t.entity_id)
        ? "idle" === t.state || 0 === this._timeRemaining
          ? (i = Ee(this._hass, this._hass.localize, t, this._hass.language))
        ...
        : (i =
            (null === (e = this._config) || void 0 === e
              ? void 0
              : e.show_units) || "sensor" !== xe(t.entity_id)
              ? Ee(this._hass, this._hass.localize, t, this._hass.language)
              : t.state);
    }
    return i;
  }
      ...
      t &&
        ...
        (i =
          (null === (e = t.attributes) || void 0 === e
            ? void 0
            : e.unit_of_measurement) && !this._config.units
  ...
  _cardHtml() {
    ...
    switch (
      ((null === (t = this._config) || void 0 === t ? void 0 : t.tooltip) &&
    ...
    this._config.aspect_ratio
      ? ((o["--aspect-ratio"] = this._config.aspect_ratio),
        (s.position = "absolute"))
      : (o.display = "inline"),
    ...
    return (
      null == s ||
        s.forEach((e) => {
          ...
          (r = Te(r, s)), (n = Me(n, s.state));
        }),
      (r = Te(r, e)),
      (r.state = Me(n, e.state)),
      r
    );
  }
  setConfig(t) {
    ...
    (i = this._configFromLLTemplates(e, i)),
      ...
      this._config.entity && Ft.has(xe(this._config.entity))
        ? (this._config = Object.assign(
    ...
    (this._hasTemplate = !(
      "all" !== this._config.triggers_update || !n.match(r)
    )),
      this._initial_setup_complete || this._initConnected();
  }
  _loopGroup(t) {
            ...
            null ===
              (i =
                null === (e = this._hass) || void 0 === e
                  ? void 0
                  : e.states[t].attributes) || void 0 === i
              ? void 0
              : i.entity_id
          );
      });
  ...
  _evalActions(t, e) {
    ...
    return (
      ...
      !i[e].confirmation &&
        i.confirmation &&
        (i[e].confirmation = n(i.confirmation)),
      i
    );
  }
  handleRippleActivate(t) {
    this._ripple.then(
      (e) => e && e.startPress && this._rippleHandlers.startPress(t)
    );
  }
  handleRippleDeactivate() {
    this._ripple.then(
      (t) => t && t.endPress && this._rippleHandlers.endPress()
    );
  }
  handleRippleFocus() {
    this._ripple.then(
      (t) => t && t.startFocus && this._rippleHandlers.startFocus()
    );
  }
  handleRippleBlur() {
    this._ripple.then(
      (t) => t && t.endFocus && this._rippleHandlers.endFocus()
    );
  }
  _handleAction(t) {
    var e;
  ...
  _handleDblTap() {
    const t = this._config;
    t &&
      Gt(this, this._hass, this._evalActions(t, "double_tap_action"), !1, !0);
  }
  _handleUnlockType(t) {
    ...
    if (this._config.lock.exemptions) {
      ...
      if (
        (this._config.lock.exemptions.forEach((t) => {
          ((!e && t.user === this._hass.user.id) ||
            t.username === this._hass.user.name) &&
            (e = !0);
        }),
        !e)
      )
...
var Xe, Ke, Qe;
t([J()], Je.prototype, "_hass", void 0),
  t([J()], Je.prototype, "_config", void 0),
  t([J()], Je.prototype, "_timeRemaining", void 0),
  t(
    [
      ((Xe = "mwc-ripple"),
      (t, e) => {
        const i = {
          async get() {
            return await this.updateComplete, this.renderRoot.querySelector(Xe);
          },
          enumerable: !0,
          configurable: !0,
        };
  ...
  (Je = t(
    [
      ...
      (t) =>
        "function" == typeof t
          ? ((t, e) => (window.customElements.define(t, e), e))(Qe, t)
          : ((t, e) => {
