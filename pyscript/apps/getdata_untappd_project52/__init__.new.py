...
def getdata_untappd_project52():
    ...
    df['month'] = pd.DatetimeIndex(df['first_checkin']).month
    ...
    agg_func_math = {
        'count': ['sum'],
        'beer_name_brewery':[pd.Series.nunique],
    ...
    t = df.groupby(['brewery_country']).agg(agg_func_math).round(2)
    ...
    attributes["data"] = jd2
    attributes["icon"] = "mdi:untappd"
    attributes["unit_of_measurement"] = "beers"
    attributes["friendly_name"] = "Untappd: Stats by Brewery"
    state.set("sensor.untappd_stats_by_brewery", value=t['beer_name_brewery_nunique'].max(), new_attributes = attributes)
    ...
    attributes["icon"] = "mdi:untappd"
    attributes["unit_of_measurement"] = "beers"
    attributes["friendly_name"] = "Untappd: Stats by Brewery Country"
    state.set("sensor.untappd_stats_by_brewerycountry", value=t['beer_name_brewery_nunique'].max(), new_attributes = attributes)
    ...
    t = df.groupby(['beer_style']).agg(agg_func_math).round(2)
    t.columns = t.columns.map('_'.join)
    maxdata = []
    maxdata.append({"max_checkin": {"count": t['count_sum'].max(), "value": t['count_sum'].idxmax()}})
    maxdata.append({"max_unique_checkin": {"count": t['beer_name_brewery_nunique'].max(), "value": t['beer_name_brewery_nunique'].idxmax()}})
    ...
    attributes["icon"] = "mdi:untappd"
    attributes["unit_of_measurement"] = "beers"
    attributes["friendly_name"] = "Untappd: Stats by Beer Style"
    state.set("sensor.untappd_stats_by_beerstyle", value=t['beer_name_brewery_nunique'].max(), new_attributes = attributes)
    ...
    t = df.groupby(['rating']).agg(agg_func_math).round(2)
    t.columns = t.columns.map('_'.join)
    maxdata = []
    maxdata.append({"max_checkin": {"count": t['count_sum'].max(), "value": t['count_sum'].idxmax()}})
    maxdata.append({"max_unique_checkin": {"count": t['beer_name_brewery_nunique'].max(), "value": t['beer_name_brewery_nunique'].idxmax()}})
    ...
    attributes["icon"] = "mdi:untappd"
    attributes["unit_of_measurement"] = "beers"
    attributes["friendly_name"] = "Untappd: Stats by Beer Rating"
    state.set("sensor.untappd_stats_by_beerrating", value=t['beer_name_brewery_nunique'].max(), new_attributes = attributes)
    ...
    attributes["icon"] = "mdi:untappd"
    attributes["unit_of_measurement"] = "beers"
    attributes["friendly_name"] = "Untappd: Stats by Beer ABV"
    state.set("sensor.untappd_stats_by_beerabv", value=t['beer_name_brewery_nunique'].max(), new_attributes = attributes)
    ...
    attributes["icon"] = "mdi:untappd"
    attributes["unit_of_measurement"] = "beers"
    attributes["friendly_name"] = "Untappd: Check-ins by Year"
    state.set("sensor.untappd_stats_by_checkinsbyyear", value=t['beer_name_brewery_nunique'].max(), new_attributes = attributes)
    ...
    attributes["icon"] = "mdi:untappd"
    attributes["unit_of_measurement"] = "beers"
    attributes["friendly_name"] = "Untappd: Check-ins by Month"
    state.set("sensor.untappd_stats_by_checkinsbymonth", value=t['beer_name_brewery_nunique'].max(), new_attributes = attributes)
    ...
    # t.columns = t.columns.map('_'.join)
    # maxdata = []
    # maxdata.append({"max_checkin": {"count": t['count_sum'].max(), "month": t['count_sum'].idxmax()}})
    # maxdata.append({"max_unique_checkin": {"count": t['beer_name_brewery_nunique'].max(), "month": t['beer_name_brewery_nunique'].idxmax()}})
    ...
    # attributes["unit_of_measurement"] = "beers"
    # attributes["friendly_name"] = "Untappd: Check-ins by Month"
    # state.set("sensor.untappd_stats_by_checkinsbymonthr", value=t['beer_name_brewery_nunique'].max(), new_attributes = attributes)
